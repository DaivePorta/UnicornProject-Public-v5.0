...
namespace Nomade.Efact.LogNegocio
{
    public class nEFBajaND
    {
		...
		public string fnGetND(string p_CTLG_CODE, string p_ND_CODE)
        {
            try
            {
                cEFBajaND ocEFBajaND = new cEFBajaND("Bn");

                // Inicio - ID del Documento
                DataTable oDT_IdDoc = ocEFBajaND.fnListarID(p_CTLG_CODE, p_ND_CODE);
               ...
               // s1C = p_ND_CODE;
                ...
                DataTable oDT_DatosEmpresa = ocEFBajaND.fnListarDatosEmpresa(p_CTLG_CODE);
                ...
                DataTable oDT_DatosDoc = ocEFBajaND.fnListarDatosDoc(p_CTLG_CODE, p_ND_CODE);
