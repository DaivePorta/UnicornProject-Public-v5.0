Public Class UnidadMedida
    ...
    End Sub
    Public Function ListarUnidadMedida(ByVal p_codigo As String, ByVal p_estado As String) As DataTable
        Try
            Dim dt As DataTable
    ...
    Public Function ActualizarUnidadMedida(ByVal p_codigo As String, ByVal p_codigosunat As String,
                                    ByVal p_descripcion As String, ByVal p_desc_cor As String, ByVal p_activo As String,
                                    ByVal p_user As String, ByVal p_unidadbase As String) As String
        Try
            Dim msg As String
