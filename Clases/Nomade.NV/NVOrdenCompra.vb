Public Class NVOrdenCompra
    ...
    Public Function ListarOrdenCompraCliente_Busq(ByVal p_OCCL_CODE As String, ByVal p_RAZON_SOCIAL As String, ByVal p_NUM_DCTO As String,
        ...
        Try
            ...
            cmd = cn.GetNewCommand("PFV_LISTAR_ORDEN_COMPRA_CLIENTE_BUSQ", CommandType.StoredProcedure)
            cmd.Parameters.Add(cn.GetNewParameter("@p_OCCL_CODE", p_OCCL_CODE, ParameterDirection.Input, 253))
    ...
    'Crea una orden de compra a cliente y sus detalles
    Public Function CrearOrdenCompraCliente(ByVal p_NUM_SERIE As String, ByVal p_NUM_DCTO As String, ByVal p_DCTO_CODE As String, ByVal p_FECHA_EMISION As String,
        ...
        Try
            ...
            cmd = cn.GetNewCommand("PFV_CREAR_ORDEN_COMPRA_CLIENTE", CommandType.StoredProcedure)
            ...
            cmd.Parameters.Add(cn.GetNewParameter("@p_OCCL_CODE", String.Empty, ParameterDirection.Output, 253))
            cmd.Parameters.Add(cn.GetNewParameter("@p_OCCL_NUM_SEQ_DOC", String.Empty, ParameterDirection.Output, 253))
            ...
            msg(0) = cmd.Parameters("@p_OCCL_CODE").Value
            msg(1) = cmd.Parameters("@p_OCCL_NUM_SEQ_DOC").Value
        ...
        End Try
    End Function
    'Actualiza una orden de compra y tambien sus detalles
    Public Function ActualizarOrdenCompraCliente(ByVal p_CODE As String, ByVal p_NUM_SERIE As String, ByVal p_NUM_DCTO As String, ByVal p_DCTO_CODE As String, ByVal p_FECHA_EMISION As String,
                                           ByVal p_FECHA_TRANS As String, ByVal p_FECHA_VENCIMIENTO As String,
                                           ByVal p_CMNT_DCTO As String, ByVal p_CTLG_CODE As String, ByVal p_SCSL_CODE As String,
                                           ByVal p_CAJA_CODE As String, ByVal p_MONE_CODE As String, ByVal p_VALOR As String,
                                           ByVal p_DESCUENTO As String, ByVal p_IGV As String, ByVal p_IMPORTE As String,
                                           ...
                                           ByVal p_VALOR_CAMBIO_OFI As String, ByVal p_COD_AUT As String, ByVal p_PCTJ_IGV As String,
                                           ByVal p_FACTOR_RENTA As String, ByVal p_IMPUESTO_RENTA As String, ByVal p_FECHA_VIGENCIA As String, ByVal p_DIAS_VIGENCIA As String,
                                           ByVal p_TIPO_IND As String, ByVal p_DIRECCION As String,
                                           Optional p_RESP_PIDM As String = Nothing
                                            ) As Array
        Try
            Dim msg(2) As String
            Dim cmd As IDbCommand
            ...
            'Los valores monetarios se ingresan en moneda base y en el procedimiento se calculan a moneda alterna 
            cmd = cn.GetNewCommand("PFV_ACTUALIZAR_ORDEN_COMPRA_CLIENTE", CommandType.StoredProcedure)
    ...
    Public Function CompletarOrdenCompraCliente(ByVal p_CODE As String, ByVal p_NUM_SERIE As String, ByVal p_NUM_DCTO As String, ByVal p_DCTO_CODE As String, ByVal p_FECHA_EMISION As String,
                                          ByVal p_FECHA_TRANS As String, ByVal p_FECHA_VENCIMIENTO As String,
                                          ByVal p_CMNT_DCTO As String, ByVal p_CTLG_CODE As String, ByVal p_SCSL_CODE As String,
                                          ByVal p_CAJA_CODE As String, ByVal p_MONE_CODE As String, ByVal p_VALOR As String,
                                          ByVal p_DESCUENTO As String, ByVal p_IGV As String, ByVal p_IMPORTE As String,
        ...
        Try
            ...
            Dim cmd As IDbCommand
            'Los valores monetarios se ingresan en moneda base y en el procedimiento se calculan a moneda alterna 
            cmd = cn.GetNewCommand("PFV_COMPLETAR_ORDEN_COMPRA_CLIENTE", CommandType.StoredProcedure)
            cmd.Parameters.Add(cn.GetNewParameter("@p_CODE", p_CODE, ParameterDirection.Input, 253))
            cmd.Parameters.Add(cn.GetNewParameter("@p_NUM_SERIE", p_NUM_SERIE, ParameterDirection.Input, 253))
            cmd.Parameters.Add(cn.GetNewParameter("@p_NUM_DCTO", p_NUM_DCTO, ParameterDirection.Input, 253))
            cmd.Parameters.Add(cn.GetNewParameter("@p_DCTO_CODE", p_DCTO_CODE, ParameterDirection.Input, 253))
    ...
    'Lista la cabecera de una orden de compra
    Public Function ListarOrdenCompraCliente(ByVal p_OCCL_CODE As String, ByVal p_RAZON_SOCIAL As String, ByVal p_NUM_DCTO As String,
        ...
        Try
            ...
            cmd = cn.GetNewCommand("PFV_LISTAR_ORDEN_COMPRA_CLIENTE", CommandType.StoredProcedure)
            cmd.Parameters.Add(cn.GetNewParameter("@p_OCCL_CODE", p_OCCL_CODE, ParameterDirection.Input, 253))
            cmd.Parameters.Add(cn.GetNewParameter("@p_RAZON_SOCIAL", p_RAZON_SOCIAL, ParameterDirection.Input, 253))
            cmd.Parameters.Add(cn.GetNewParameter("@p_NUM_DCTO", p_NUM_DCTO, ParameterDirection.Input, 253))
            cmd.Parameters.Add(cn.GetNewParameter("@p_CTLG_CODE", p_CTLG_CODE, ParameterDirection.Input, 253))
    ...
    'Lista los detalles de una orden de compra 
    Public Function ListarDetalleOrdenCompraCliente(ByVal p_OCCL_CODE As String, ByVal p_OCCL_NUM_SEQ_DOC As String,
                                   ByVal p_ITEM As String) As DataTable
        Try
            Dim dt As DataTable
            Dim cmd As IDbCommand

            cmd = cn.GetNewCommand("PFV_LISTAR_DETALLE_ORDEN_COMPRA_CLIENTE", CommandType.StoredProcedure)
            cmd.Parameters.Add(cn.GetNewParameter("@p_OCCL_CODE", p_OCCL_CODE, ParameterDirection.Input, 253))
            cmd.Parameters.Add(cn.GetNewParameter("@p_OCCL_NUM_SEQ_DOC", p_OCCL_NUM_SEQ_DOC, ParameterDirection.Input, 253))
    ...
    'Lista los cabecera de una orden de compra 
    Public Function ListarCabeceraOrdenCompraCliente(ByVal p_OCCL_CODE As String) As DataTable
        Try
            Dim dt As DataTable
            Dim cmd As IDbCommand

            cmd = cn.GetNewCommand("PFV_LISTAR_CABECERA_ORDEN_COMPRA_CLIENTE", CommandType.StoredProcedure)
            cmd.Parameters.Add(cn.GetNewParameter("@p_OCCL_CODE", p_OCCL_CODE, ParameterDirection.Input, 253))
            dt = cn.Consulta(cmd)
            If Not (dt Is Nothing) Then
                Return dt
    ...
    'Lista los cabecera de una COTIZACION 
    Public Function ListarCabeceraCotizacionCliente(ByVal p_OCCL_CODE As String) As DataTable
        Try
            Dim dt As DataTable
            Dim cmd As IDbCommand

            cmd = cn.GetNewCommand("PFV_LISTAR_CABECERA_COTIZACION_CLIENTE", CommandType.StoredProcedure)
            cmd.Parameters.Add(cn.GetNewParameter("@p_OCCL_CODE", p_OCCL_CODE, ParameterDirection.Input, 253))
            dt = cn.Consulta(cmd)
            If Not (dt Is Nothing) Then
                Return dt
