...
Public Class NCTipoPago
    ...
    Public Function Listar_TiPago(ByVal p_CODE As String, ByVal p_CODE_SUNAT As String, ByVal p_ESTADO As String) As DataTable
        Try
            Dim dt As DataTable
    ...
    Public Function Crear_TiPago(ByVal p_COD_SUNAT As String, ByVal p_DESC As String, ByVal p_NOM_CORTO As String, ByVal p_ESTADO_ID As String, p_USUA_ID As String) As Array
        ...
        Try
            ...
            cmd = cn.GetNewCommand("PFC_CREAR_TIPO_PAGO", CommandType.StoredProcedure)
    ...
    Public Function Actualizar_TiPago(ByVal p_CODE As String, ByVal p_CODE_SUNAT As String, ByVal p_DESC As String, ByVal p_NOM_CORTO As String, ByVal p_ESTADO_ID As String, p_USUA_ID As String) As Array
        ...
        Try
            ...
            cmd = cn.GetNewCommand("PFC_ACTUALIZAR_TIPO_PAGO", CommandType.StoredProcedure)
            cmd.Parameters.Add(cn.GetNewParameter("@p_CODE", p_CODE, ParameterDirection.Input, 253))
            cmd.Parameters.Add(cn.GetNewParameter("@p_CODE_SUNAT", p_CODE_SUNAT, ParameterDirection.Input, 253))
            cmd.Parameters.Add(cn.GetNewParameter("@p_DESC", p_DESC, ParameterDirection.Input, 253))
            cmd.Parameters.Add(cn.GetNewParameter("@p_NOM_CORTO", p_NOM_CORTO, ParameterDirection.Input, 253))
    ...
    Public Function CambiarEstado_TipoPago(ByVal p_CODE As String) As Array
        Try
            ...
            cmd = cn.GetNewCommand("PFC_CAMBIAR_ESTADO_TIPO_PAGO", CommandType.StoredProcedure)
            cmd.Parameters.Add(cn.GetNewParameter("@p_CODE", p_CODE, ParameterDirection.Input, 253))
