Public Class NCTipoClienteProveedor
    ...
    End Sub
    Public Function ListarTipoClienteProveedor(ByVal p_code As String, ByVal p_tipo_ind As String, ByVal p_estado As String,
    ...
    Public Function ListarClaseCliente(ByVal p_ctlg_code As String, ByVal p_estado_ind As String, ByVal p_tipo_ind As String) As DataTable
        Try
            Dim dt As DataTable
            Dim cmd As IDbCommand

            cmd = cn.GetNewCommand("LISTAR_CLASE_CLIENTE", CommandType.StoredProcedure)
            cmd.Parameters.Add(cn.GetNewParameter("@p_CTLG", p_ctlg_code, ParameterDirection.Input, 253))
    ...
    Public Function ListarCategoriaCliente(ByVal p_prod As String, ByVal p_code As String, ByVal p_tipo_ind As String, ByVal p_estado As String, ByVal p_ctlg_code As String, ByVal p_scsl_code As String) As DataTable
        Try
            Dim dt As DataTable
            Dim cmd As IDbCommand

            cmd = cn.GetNewCommand("PFV_LISTAR_CATEGORIA_CLIENTE", CommandType.StoredProcedure)
            cmd.Parameters.Add(cn.GetNewParameter("@p_PROD_CODE", p_prod, ParameterDirection.Input, 253))
            cmd.Parameters.Add(cn.GetNewParameter("@p_TIPO_IND", p_tipo_ind, ParameterDirection.Input, 253))
            cmd.Parameters.Add(cn.GetNewParameter("@p_ESTADO_IND", p_estado, ParameterDirection.Input, 253))
            cmd.Parameters.Add(cn.GetNewParameter("@p_CODE", p_code, ParameterDirection.Input, 253))
