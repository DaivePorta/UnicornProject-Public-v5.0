Public Class NCTipoTV
    Private cn As Nomade.Connection
    Dim dt As DataTable
    Public Sub New(ByVal str As String)
        cn = New Nomade.Connection(str)
    End Sub
    Public Function ListarTipoTV(ByVal p_codigo As String, ByVal p_estado As String) As DataTable
        Try
            Dim dt As DataTable
            Dim cmd As IDbCommand

            cmd = cn.GetNewCommand("PFC_LISTAR_TIPO_TV", CommandType.StoredProcedure)
    ...
    Public Function ActualizarTipoTV(ByVal p_codigo As String, ByVal p_codigosunat As String,
        ...
        Try
            ...
            cmd = cn.GetNewCommand("PFC_ACTUALIZAR_TIPO_TV", CommandType.StoredProcedure)
    ...
    Public Function CrearTipoTV(ByVal p_codigosunat As String,
                                        ByVal p_descripcion As String, ByVal p_abreviatura As String, ByVal p_activo As String,
                                       ByVal p_user As String) As String
        ...
        Try
            ...
            cmd = cn.GetNewCommand("PFC_CREAR_TIPO_TV", CommandType.StoredProcedure)
    ...
    Public Function CambiarEstadoTipoTV(ByVal p_codigo As String) As String
        Try
            ...
            cmd = cn.GetNewCommand("PFC_CAMBIAR_ESTADO_TIPO_TV", CommandType.StoredProcedure)
            cmd.Parameters.Add(cn.GetNewParameter("@p_CODE", p_codigo, ParameterDirection.Input, 253))
