Public Class NCOcupacion
    Private cn As Nomade.Connection
    Dim dt As DataTable
    Public Sub New(ByVal str As String)
        cn = New Nomade.Connection(str)
    End Sub
    Public Function ListarOcupacion(ByVal p_codigo As String, ByVal p_estado As String) As DataTable
        Try
            Dim dt As DataTable
            Dim cmd As IDbCommand

            cmd = cn.GetNewCommand("PFC_LISTAR_OCUPACION", CommandType.StoredProcedure)
    ...
    Public Function ActualizarOcupacion(ByVal p_codigo As String, ByVal p_codigosunat As String,
                                       ByVal p_nombre As String, ByVal p_nombrecorto As String, ByVal p_nivel As String, ByVal p_activo As String,
        ...
        Try
            ...
            cmd = cn.GetNewCommand("PFC_ACTUALIZAR_OCUPACION", CommandType.StoredProcedure)

            cmd.Parameters.Add(cn.GetNewParameter("@p_CODE", p_codigo, ParameterDirection.Input, 253))
            cmd.Parameters.Add(cn.GetNewParameter("@p_CODIGO_SUNAT", p_codigosunat, ParameterDirection.Input, 253))
            cmd.Parameters.Add(cn.GetNewParameter("@p_NOMBRE_OCUPACION", p_nombre, ParameterDirection.Input, 253))
    ...
    Public Function CrearOcupacion(ByVal p_codigosunat As String,
                                       ByVal p_nombre As String, ByVal p_nombrecorto As String, ByVal p_nivel As String, ByVal p_activo As String,
                                       ByVal p_user As String) As String
        ...
        Try
            ...
            cmd = cn.GetNewCommand("PFC_CREAR_OCUPACION", CommandType.StoredProcedure)
    ...
    Public Function CambiarEstadoOcupacion(ByVal p_codigo As String) As String
        Try
            ...
            cmd = cn.GetNewCommand("PFC_CAMBIAR_ESTADO_OCUPACION", CommandType.StoredProcedure)
            cmd.Parameters.Add(cn.GetNewParameter("@p_CODE", p_codigo, ParameterDirection.Input, 253))
