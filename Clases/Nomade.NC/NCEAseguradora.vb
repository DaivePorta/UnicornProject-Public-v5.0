Public Class NCEAseguradora
    Private cn As Nomade.Connection
    Dim dt As DataTable
    Public Sub New(ByVal str As String)
        cn = New Nomade.Connection(str)
    End Sub
    Public Function ListarAseguradora(ByVal p_id As String, ByVal p_estado As String, ByVal p_empresa As String) As DataTable
        Try
            Dim dt As DataTable
            Dim cmd As IDbCommand

            cmd = cn.GetNewCommand("PFC_LISTAR_ASEGURADORA", CommandType.StoredProcedure)
    ...
    Public Function ActualizarAseguradora(ByVal p_pidm As String, ByVal p_fechai As String, ByVal p_fechat As String, ByVal p_empresa As String, ByVal p_activo As String, ByVal p_user As String) As String
        Try
            Dim msg As String
            ...
            cmd = cn.GetNewCommand("PFC_ACTUALIZAR_ASEGURADORA", CommandType.StoredProcedure)
    ...
    Public Function CrearAseguradora(ByVal p_pidm As String, ByVal p_fechai As String, ByVal p_fechat As String, ByVal p_empresa As String, ByVal p_activo As String, ByVal p_user As String) As String
        ...
        Try
            ...
            cmd = cn.GetNewCommand("PFC_CREAR_ASEGURADORA", CommandType.StoredProcedure)
