Public Class CPDetraccionProveedor
    ...
    Public Function CrearDetraccionProveedor(
      ...
      ByVal p_FVCDETRA_CTLG_CODE As String, _
      ByVal p_FCVDETRA_MONTO_PAGADO As String, _
      ByVal p_FVCDETRA_MONEDA_CODE As String, _
      ByVal p_FVCDETRA_SCSL_CODE As String
     ) As String
        Try
            Dim msg As String
            ...
            cmd.Parameters.Add(cn.GetNewParameter("@p_FVCDETRA_TIPO", "P", ParameterDirection.Input, 253))
            ...
            cmd.Parameters.Add(cn.GetNewParameter("@p_FVCDETRA_FECHA_PAGO", Nothing, ParameterDirection.Input, 253))
            ...
            cmd.Parameters.Add(cn.GetNewParameter("@p_FCVDETRA_MONTO_PAGADO", p_FCVDETRA_MONTO_PAGADO, ParameterDirection.Input, 253))
            cmd.Parameters.Add(cn.GetNewParameter("@p_FVCDETRA_MONEDA_CODE", p_FVCDETRA_MONEDA_CODE, ParameterDirection.Input, 253))
            cmd.Parameters.Add(cn.GetNewParameter("@p_FVCDETRA_SCSL_CODE", p_FVCDETRA_SCSL_CODE, ParameterDirection.Input, 253))
    ...
    Public Function PagarDetraccionProveedorCaja(ByVal p_detalle As String, ByVal p_caja_code As String,
                               ...
                               ByVal p_descripcion As String, ByVal p_destino As String, ByVal p_documento As String, Optional ByVal p_MONTO_TOTAL As String = "",
                               Optional ByVal p_ind As String = "CAJ", Optional ByVal p_pidm As String = "", Optional ByVal p_cta_code As String = "",
                                Optional ByVal p_oficina As String = "", Optional ByVal p_canal As String = "", Optional ByVal p_ind_completo As String = "",
                                 Optional ByVal p_adicional As String = "") As String
        Try
            Dim msg As String
            Dim cmd As IDbCommand
            cmd = cn.GetNewCommand("PVC_PAGAR_DETRACCION_DCTO", CommandType.StoredProcedure)
    ...
    Public Function PagarDetraccionProveedorBanco(ByVal p_detalle As String, ByVal p_pidm As String, ByVal p_cta_code As String,
                              ...
                              ByVal p_destino As String, ByVal p_documento As String, ByVal p_ind_completo As String, ByVal p_MONTO_TOTAL As String, Optional ByVal p_adicional As String = "",
    ...
    Public Function ListarDetraccionProveedor(
