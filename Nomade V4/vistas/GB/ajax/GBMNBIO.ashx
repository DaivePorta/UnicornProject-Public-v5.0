<%@ WebHandler Language="VB" Class="GBMNBIO" %>

Imports System
Imports System.Web
Imports System.Data

Public Class GBMNBIO : Implements IHttpHandler
        ...
        Try
            Select Case OPCION
                ...
                Case "1"
                    ...
                    dt = New Nomade.MP.MPOrdenFabricacion("BN").BUSCAR_FLUJO_SOLICITUD(P_CODE, P_CODE_PROD, Convert.ToDateTime(P_FECHAINI), Convert.ToDateTime(P_FECHAFIN), P_TIPO)
