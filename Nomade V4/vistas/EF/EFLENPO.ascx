<%@ Control Language="VB" AutoEventWireup="false" CodeFile="EFLENPO.ascx.vb" Inherits="vistas_EF_EFLENPO" %>
...
<script type='text/javascript' src='../vistas/EF/js/EFLENPO.js?<%=aleatorio%>'></script>
