<%@ Control Language="VB" AutoEventWireup="false" CodeFile="EFLFACT.ascx.vb" Inherits="vistas_EF_WebUserControl" %>
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            ...
            <div class="portlet-body">
                ...
                <div class="row-fluid">
                    <div class="span4" style="float: left; margin-right: 50%;">         
                        <a id="btnEnviarTodos" class="btn green"><i class="fa fa-paper-plane"></i>&nbsp;ENVIAR LOTE</a>
                    </div>
                </div>
            ...
            <div class="span11" id="divDocTodos">
                <div class="row-fluid">
                    <div class="span12">
                        ...
                        <div class="control-group">
                            <label class="control-label" style="text-align:center; font-size:12px;"><strong>¿Estas Seguro de enviar todos los documentos?</strong></label>
                        </div>
                    </div>    
...
<script type='text/javascript' src='../vistas/EF/js/EFLFACT.js?<%=aleatorio%>'></script>
