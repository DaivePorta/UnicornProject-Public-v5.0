<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NMLPROD.ascx.vb" Inherits="vistas_NM_NMLPROD" %>
<style>
    ...
    <div class="span12 ">
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4>
                    <i class="icon-reorder"></i>LISTA DE PRODUCTOS/SERVICIOS</h4>
                <div class="actions">
                    <a class="btn black printlist "><i class="icon-print"></i>&nbsp;Imprimir</a>
                    <a href="?f=nmmprod" class="btn green"><i class="icon-plus"></i>&nbsp;Nuevo</a>
                    <a href="?f=nmlprod" class="btn red"><i class="icon-list"></i>&nbsp;Listar</a>
                </div>
            </div>
...
<script type="text/javascript" src="../vistas/NM/js/NMMPROD.js"></script>
<script>
