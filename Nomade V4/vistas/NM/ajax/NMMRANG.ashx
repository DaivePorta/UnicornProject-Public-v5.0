<%@ WebHandler Language="VB" Class="NMMRANG" %>

Imports System
Imports System.Web
Imports System.Data

Public Class NMMRANG : Implements IHttpHandler
    Dim OPCION As String
    Dim p_USUA_ID, p_CODE, p_NOMBRE, p_RANGO_INICIO As String
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        p_RANGO_INICIO = context.Request("p_RANGO_INICIO")
        ...
        Try
            Select Case OPCION
                ...
                Case "1" 'listar rangos
                    ...
                    If Not (dt Is Nothing) Then
                        ...
                        For Each MiDataRow As DataRow In dt.Rows
                            ...
                            resb.Append("""RANGO_INICIO"" :" & """" & MiDataRow("RANGO_INICIO").ToString & """,")
                ...
                Case "2"
                    Try
                        res = nmGestionPrecios.RegistrarRangoPrecioCantidad(p_NOMBRE, p_RANGO_INICIO, p_USUA_ID)
                ...
                Case "4"
                    context.Response.ContentType = "application/json; charset=utf-8"
                    dt = nmGestionPrecios.ListarRangoPrecioListaCliente("")
                    If Not (dt Is Nothing) Then
                        resb.Append("[")
                        For Each MiDataRow As DataRow In dt.Rows
                            resb.Append("{")
