<%@ WebHandler Language="VB" Class="NRMGETR" %>
...
Public Class NRMGETR : Implements IHttpHandler
        ...
        Select Case OPCION
            ...
            Case "NPN"
                ...
                resArray = grabarPersonaNatural(APELL_PATE, APELL_MATE, NOMBRE, FECHA, AGENTE_RETEN_IND,
                               ...
                               CORREO, TIPO, RUTA_PPBIMAG, PPBIMAG_NOMBRE_RUC, INICIO_ACTIVIDAD, TIPO_CONTRIBUYENTE, RAZO_COME, ACTIVIDAD, sCONDI_SUNAT, sESTADO_SUNAT)
                resb.Append("[")
                resb.Append("{")
            ...
            Case "NPMN"
                ...
                resArray = grabarPersonaNatural(APELL_PATE, APELL_MATE, NOMBRE, FECHA, AGENTE_RETEN_IND,
                                ENTIDAD_IND, TINO_CODE, USUA_ID, SEXO, ESCI_CODE, DOID_CODE,
                               NRO, NRO_RUC, ESTADO_IND, PPRTELE_TIDT_CODE, OPERADOR, NUMERO, PPRCORR_TIDT_CODE,
                               CORREO, TIPO, RUTA_PPBIMAG, PPBIMAG_NOMBRE_RUC, String.Empty, String.Empty, String.Empty, String.Empty, sCONDI_SUNAT, sESTADO_SUNAT)
                resb.Append("[")
                resb.Append("{")
                resb.Append("""p_PPBIDEN_PIDM"" :" & """" & resArray(0).ToString & """,")
                resb.Append("""p_PPBIDEN_ID"" :" & """" & resArray(1).ToString & """,")
    ...
    Public Function grabarPersonaNatural(ByVal p_PPBIDEN_APELL_PATE As String, ByVal p_PPBIDEN_APELL_MATE As String, ByVal p_PPBIDEN_NOMBRE As String, ByVal p_PPBIDEN_FECHA As String, ByVal p_PPBIDEN_AGENTE_RETEN_IND As String,
                                  ...
                                  ByVal p_TIPO_CONTRIBUYENTE As String, ByVal p_RAZO_COME As String, ByVal p_ACTIVIDAD As String, ByVal p_PPBIDEN_COND_SUNAT As String, ByVal p_PPBIDEN_ESTADO_SUNAT As String) As Array
        ...
        datos = q.crear_Persona_Natural(p_PPBIDEN_APELL_PATE, p_PPBIDEN_APELL_MATE, p_PPBIDEN_NOMBRE, p_PPBIDEN_FECHA, p_PPBIDEN_AGENTE_RETEN_IND,
                                   ...
                                   p_PPRCORR_CORREO, p_PPBIMAG_TIPO, p_PPBIMAG_NOMBRE, p_PPBIMAG_NOMBRE_RUC, p_INICIO_ACTIVIDAD, p_TIPO_CONTRIBUYENTE, p_RAZO_COME, p_ACTIVIDAD, p_PPBIDEN_COND_SUNAT, p_PPBIDEN_ESTADO_SUNAT)
        Return datos
    End Function
