...
var NRLGEPR = function () {
    ...
    var fillBandejaPersonas = function () {
        ...
        //      .appendTo($(this).empty())
        //        .on('change', function () {
        //            oTablePersonas.fnFilter($("#slcfilempr :selected").html() == "Todo" ? "" : $("#slcfilempr :selected").html(), 5)
        //        });
        //    if (json != null) {
        ...
        $('#cboEmpresas').on('change', function () {
            //oTablePersonas.fnFilter($("#cboEmpresas :selected").html() == "Todo" ? "" : $("#cboEmpresas :selected").html(), 5)
            oTablePersonas.fnFilter($("#cboEmpresas :selected").html() == "Todo" ? "" : $("#cboEmpresas").val(), 8)
