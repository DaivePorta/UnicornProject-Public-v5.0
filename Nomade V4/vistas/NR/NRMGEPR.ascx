<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NRMGEPR.ascx.vb" Inherits="vistas_NR_NRMGEPR" %>
    ...
    <div class="span12">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>PROVEEDOR</h4>
                <div class="actions">
                    <a class="btn green" href="?f=NRMGEPR"><i class="icon-plus"></i>&nbsp;Nuevo</a>
                    <a class="btn red" href="?f=NRLGEPR"><i class="icon-list"></i>&nbsp;Listar</a>
                </div>
