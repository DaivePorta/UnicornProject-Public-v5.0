<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NRMGETR.ascx.vb" Inherits="vistas_NR_NRMGETR" %>
    ...
    <div class="span12">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>TRANSPORTISTA</h4>
                <div class="actions">
                    <a class="btn green" href="?f=NRMGETR"><i class="icon-plus"></i>&nbsp;Nuevo</a>
                    <a class="btn red" href="?f=NRLGETR"><i class="icon-list"></i>&nbsp;Listar</a>
                </div>
