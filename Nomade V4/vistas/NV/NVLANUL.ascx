<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVLANUL.ascx.vb" Inherits="vistas_NV_NVLANUL" %>
<style>
    @media print {
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>ANULACIÓN DE DOCUMENTOS DE VENTA</h4>
                <div class="actions">
                  <%--  <a class="btn black printlist"><i class="icon-print"></i>&nbsp;Imprimir</a>    
                    <a class="btn green" href="?f=nvmdocv"><i class="icon-plus"></i>&nbsp;Nuevo</a>    --%>   
                     <a class="btn black" onclick="javascript:imprimirDctosVenta();" style="margin-top:-10px;"><i class="icon-print"></i>&nbsp;Imprimir</a>  
                </div>
            </div>
...
<script type="text/javascript" src="../vistas/NV/js/NVMANUL.js?<%=aleatorio%>"></script>
<script>
