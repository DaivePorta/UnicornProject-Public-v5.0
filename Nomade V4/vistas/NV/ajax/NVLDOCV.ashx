<%@ WebHandler Language="VB" Class="NVLDOCV" %>

Imports System
Imports System.Web
Imports System.Data

Public Class NVLDOCV : Implements IHttpHandler
        ...
        Try
            Select Case OPCION
                ...
                Case "2" ' LISTA VENDEDORES POR ROL
                    ...
                    End If
                    res = resb.ToString()
                Case "LDVNORMAL" ' Obtiene Docunento
                    context.Response.ContentType = "application/text; charset=utf-8"
                    dt = nvVenta.ListarDocVenta_Normal("", CLIENTE, NUM_DCTO, DCTO_CODE, VENDEDOR, ESTADO, PRODUCTO, SERIE_DCTO, Utilities.fechaLocal(DESDE), Utilities.fechaLocal(HASTA), CTLG_CODE, SCSL_CODE)
    ...
    Public Function GenerarTablaDocumento(ByVal dt As DataTable) As String
        ...
        If (dt IsNot Nothing) Then
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                resb.AppendFormat("<td align='left' >{0}<br/><small style='color:#6C7686;'>{1}</small></td>", dt.Rows(i)("MOPA_DESC").ToString(), If(dt.Rows(i)("CONTRAENTREGA_IND") = "S", "*Contraentrega", ""))
