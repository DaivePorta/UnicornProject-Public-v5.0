<%@ WebHandler Language="VB" Class="NVMOCCL" %>

Imports System
Imports System.Web
Imports System.Data

Public Class NVMOCCL : Implements IHttpHandler
    ...
    Dim p_NUM_SERIE, p_NUM_DCTO, p_DCTO_CODE, p_FECHA_EMISION, p_FECHA_TRANS, p_FECHA_VENCIMIENTO,
       ...
       p_DCTO_NUM_REF, p_VALOR_CAMBIO_OFI, p_COD_AUT, p_PCTJ_IGV, p_FACTOR_RENTA, p_IMPUESTO_RENTA, p_RESP_PIDM, p_FECHA_VIGENCIA, p_DIAS_VIGENCIA, p_TIPO_IND As String
    Dim p_DIRECCION As String
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Try
            ...
            Select Case OPCION
                ...
                Case "5" 'CREAR ORDEN DE COMPRA A CLIENTE            
                    context.Response.ContentType = "application/json; charset=utf-8"
                    Dim array As Array
                    array = nvOrdenCompra.CrearOrdenCompraCliente(p_NUM_SERIE, p_NUM_DCTO, p_DCTO_CODE,
                    ...
                    If(p_FECHA_VIGENCIA = "", Nothing, Utilities.fechaLocal(p_FECHA_VIGENCIA)),
                    p_DIAS_VIGENCIA, p_TIPO_IND, p_DIRECCION, If(p_RESP_PIDM = "", Nothing, p_RESP_PIDM))
                ...
                Case "7" 'ACTUALIZAR ORDEN DE COMPRA CLIENTE           
                    context.Response.ContentType = "application/json; charset=utf-8"
                    Dim array As Array
                    array = nvOrdenCompra.ActualizarOrdenCompraCliente(p_CODE, p_NUM_SERIE, p_NUM_DCTO, p_DCTO_CODE,
                                             If(p_FECHA_EMISION = "", Nothing, Utilities.fechaLocal(p_FECHA_EMISION)),
                                             If(p_FECHA_TRANS = "", Nothing, Utilities.fechaLocal(p_FECHA_TRANS)),
                                             If(p_FECHA_VENCIMIENTO = "", Nothing, Utilities.fechaLocal(p_FECHA_VENCIMIENTO)),
                    p_CMNT_DCTO, p_CTLG_CODE, p_SCSL_CODE, p_CAJA_CODE, p_MONE_CODE, p_VALOR, p_DESCUENTO, p_IGV, p_IMPORTE,
                ...
                Case "8" 'COMPLETAR ORDEN DE COMPRA CLIENTE            
                    context.Response.ContentType = "application/json; charset=utf-8"
                    Dim array As Array
                    array = nvOrdenCompra.CompletarOrdenCompraCliente(p_CODE, p_NUM_SERIE, p_NUM_DCTO, p_DCTO_CODE,
                                             If(p_FECHA_EMISION = "", Nothing, Utilities.fechaLocal(p_FECHA_EMISION)),
                                             If(p_FECHA_TRANS = "", Nothing, Utilities.fechaLocal(p_FECHA_TRANS)),
                                             If(p_FECHA_VENCIMIENTO = "", Nothing, Utilities.fechaLocal(p_FECHA_VENCIMIENTO)),
                    p_CMNT_DCTO, p_CTLG_CODE, p_SCSL_CODE, p_CAJA_CODE, p_MONE_CODE, p_VALOR, p_DESCUENTO, p_IGV, p_IMPORTE,
                ...
                Case "LDOCC" ' LISTAR CABECERA ORDEN DE COMPRA
                    context.Response.ContentType = "application/json; charset=utf-8"
                    dt = nvOrdenCompra.ListarOrdenCompraCliente(If(p_FVBVTAC_CODE = Nothing, "", p_FVBVTAC_CODE), "", "", If(p_CTLG_CODE = Nothing, "", p_CTLG_CODE),
                                                       If(p_SCSL_CODE = Nothing, "", p_SCSL_CODE), If(p_MONE_CODE = Nothing, "", p_MONE_CODE), If(TIPO_DCTO = Nothing, "", TIPO_DCTO),
                    ...
                    If Not (dt Is Nothing) Then
                        ...
                        For Each row As DataRow In dt.Rows
                            ...
                            resb.Append("""DIRECCION_REGISTRADA_CLIENTE"":""" & row("DIRECCION_REGISTRADA_CLIENTE").ToString & """,")
                ...
                Case "LDOCD" ' LISTAR DETALLES ORDEN DE COMPRA

                    context.Response.ContentType = "application/json; charset=utf-8"
                    dt = nvOrdenCompra.ListarDetalleOrdenCompraCliente(If(p_FVBVTAC_CODE = Nothing, "", p_FVBVTAC_CODE), "0", "")
                    If Not (dt Is Nothing) Then
                        resb.Append("[")
                        For Each row As DataRow In dt.Rows
                            resb.Append("{")
    ...
    Public Function GenerarDctoImprimir(ByVal p_CODE As String, ByVal USAR_IGV_IND As String) As String
        ...
        dtCabecera = nvOrdenCompra.ListarOrdenCompraCliente(p_CODE, "", "", "", "", "", "", "", "", "")
        dtDetalles = nvOrdenCompra.ListarDetalleOrdenCompraCliente(p_CODE, "0", "")
        If dtCabecera IsNot Nothing Then
            ...
            tabla.AppendFormat("<tr><td style='vertical-align: top;'><strong>{1}<span style='float:right;clear:both;'>:</span></strong></td><td colspan='3'>{0}</td></tr>", dtCabecera.Rows(0)("NUM_DCTO"), "O/C")
