<%@ WebHandler Language="VB" Class="NVMDEBC" %>

Imports System
Imports System.Web
Imports System.Data

Public Class NVMDEBC : Implements IHttpHandler
        ...
        Try
            ...
            Select Case OPCION
                ...
                Case "1" ' LISTAR DOCUMENTOS DE VENTA - DOCUMENTOS DE REFERENCIA
                    ...
                    dt = caNotaCredito.ListarDocumentosVenta2("", "", "", "", "", p_CTLG_CODE, p_SCSL_CODE, p_DCTO_REF_TIPO_CODE, USUA_ID)
                    If p_DCTO_REF_TIPO_CODE = "0007" Then 'DPORTA
                        res = GenerarTablaDocumentosNC()
                    Else
                ...
                Case "MND" 'Lista cheques
                    context.Response.ContentType = "application/json; charset=utf-8"
                    Dim dt As New DataTable
                    dt = caNotaDebito.ListarMotivoNotaDebito(p_ESTADO)
        ...
        If Not (dt Is Nothing) Then
            For i As Integer = 0 To dt.Rows.Count - 1
                If dt.Rows(i)("COMPLETO_IND").ToString = "S" And dt.Rows(i)("ANULADO").ToString = "NO" Then
                    ...
                    resb.AppendFormat("<td align='center' >{0}</td>", If(dt.Rows(i)("MONEDA").ToString() = "0002", "S/ " + dt.Rows(i)("IMPORTE").ToString(), "$ " + dt.Rows(i)("IMPORTE").ToString()))
    ...
    Public Function GenerarTablaDocumentosNC() As String 'DPORTA
        resb.Clear()
        resb.Append("<table id=""tblBuscarDocumento"" class=""display DTTT_selectable"" border=""0"">")
        resb.Append("<thead>")
        resb.AppendFormat("<th>CÓDIGO</th>")
