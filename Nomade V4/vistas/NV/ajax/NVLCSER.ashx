<%@ WebHandler Language="VB" Class="NVLCSER" %>

Imports System
Imports System.Web
Imports System.Data

Public Class NVLCSER : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Select Case OPCION
            Case "2" 'LISTAR CATALOGO SERVICIOS
                Try
                    context.Response.ContentType = "application/json; charset=utf-8"
                    dt = nmGestionProductos.ListarCatalogoServicios("", CTLG_CODE, ALMC_CODE, GRUPO_CODE, SUBGRUPO_CODE, MARCA_CODE, ESTADO_IND, STOCK_IND)
