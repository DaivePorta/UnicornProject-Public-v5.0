<%@ WebHandler Language="VB" Class="NVLCLVE" %>

Imports System
Imports System.Web
Imports System.Data

Public Class NVLCLVE : Implements IHttpHandler
        ...
        Try
            Select Case OPCION
                Case "1" 'Generar tabla 
                    ...
                    dt = nvVenta.ReporteAnaliticoVentasTodosLosClientes(p_CTLG_CODE, p_SCSL_CODE, p_MONE_CODE, p_ANIOS, p_MESES)
