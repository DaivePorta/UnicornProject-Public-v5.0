    ...
    Public Function GenerarTablaDocumento(ByVal dt As DataTable) As String
        ...
        If (dt IsNot Nothing) Then
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                resb.AppendFormat("<td align='left' >{0}</td>", dt.Rows(i)("ESTADO_DOC").ToString())
                resb.AppendFormat("<td align='left' >{0}</td>", dt.Rows(i)("REFERENCIA").ToString())
                resb.AppendFormat("<td style='text-align:center;'>")
                resb.AppendFormat("<a class='btn blue' onclick=""imprimirDetalle('{0}','{1}')""><i class='icon-search'></i></a>", dt.Rows(i)("CODIGO").ToString(), dt.Rows(i)("NUM_DCTO").ToString())
    ...
    Public Function GenerarTablaDocumentoImprimir(ByVal dt As DataTable) As String
        ...
        If (dt IsNot Nothing) Then
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                resb.AppendFormat("<td align='left' >{0}</td>", dt.Rows(i)("CLIE_DCTO_NROX").ToString())
                resb.AppendFormat("<td align='left' >{0}</td>", dt.Rows(i)("RAZON_SOCIAL").ToString())
                ...
                resb.AppendFormat("<td align='left' >{0}</td>", dt.Rows(i)("VENDEDOR").ToString())
                resb.AppendFormat("<td align='center' >{0}</td>", dt.Rows(i)("ESTADO_DOC").ToString())
                resb.AppendFormat("<td align='left' >{0}</td>", dt.Rows(i)("REFERENCIA").ToString())
