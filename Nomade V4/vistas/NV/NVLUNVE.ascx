<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVLUNVE.ascx.vb" Inherits="vistas_NV_NVLUNVE" %>
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>UNIDADES VENDIDAS</h4>
                <div class="actions">
            ...
            <div class="portlet-body">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span1" style="float: right; margin-right: 50%;">
                ...
                <div class="row-fluid" style="margin-top: 10px;">
                    <div id="divDocumento">
                        <table id="tblDocumento" class="display DTTT_selectable" border="0" style="width:auto!important;">
                            <thead>
                                <tr>
                                    <th>CODIGO</th>
                                    <th>DESCRIPCION</th>
...
<script type="text/javascript" src="../vistas/NV/js/NVLUNVE.js"></script>
<script>
