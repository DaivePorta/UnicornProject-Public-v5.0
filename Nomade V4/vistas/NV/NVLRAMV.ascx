<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVLRAMV.ascx.vb" Inherits="vistas_NV_NVLRAMV" %>
    ...
    <div class="span12 ">
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>REPORTE ANALITICO DE MARCAS VENDIDAS</h4>
                <div class="actions">
                        ...
                        <table id="tblReporteMostrar" class="table table-bordered table-hover" style="margin-left: 10px">
                            <thead>
                                <tr>
                                    ...
                                    <th style="display:none">COD_MARCA</th>
                                    <th>MARCA</th>
    ...
    <div class="modal-body">
        <div class="row-fluid">            
            <div class="span12" id="divBuscarDoc_body">
                ...
                <table id="tbl_ventas_marcas" class="display DTTT_selectable" border="0" style="font-size:12px;">
                <thead>
                    <tr>                        
                        <th>CODIGO
                        </th>                        
...
<script type="text/javascript" src="../vistas/NV/js/NVLRAMV.js"></script>
<script>
