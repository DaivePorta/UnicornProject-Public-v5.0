<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVMDOVE.ascx.vb" Inherits="vistas_NV_NVMDOVE" %>
<style type="text/css">
    ...
    <div class="span12">
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>DOCUMENTO VENTA RÁPIDA ESPECIAL</h4>
                <div class="actions">
                                ...
                                <div class="row-fluid">
                                            ...
                                            <div class="span3">
                                                <div class="control-group span12">
                                                    <div class="controls pull-right">
                                                        ...
                                                        <a id="btnNuevaPersona"  onclick="NuevoCliente();" title="Nuevo" class="btn green" style="margin-bottom: 2px;"><i class="icon-plus"></i></a>
                                    ...
                                    <div class="span4">
                                        ...
                                        <div class="span12" id="p_DatCobro" style="margin-left: 0">
                                            <div class="portlet box blue">
                                                <div class="portlet-title" style="cursor: pointer;">
                                                    <h4><i class="icon-chevron-down"></i>Cobro de Venta <small id="msgCobro" style="font-style: italic; color: white;">*Obligatorio</small></h4>
                                                </div>
                                                <div class="portlet-body">
...
<script type="text/javascript" src="../vistas/NV/js/NVMDOVE.js"></script>
