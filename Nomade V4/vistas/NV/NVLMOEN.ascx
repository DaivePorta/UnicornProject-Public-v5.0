<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVLMOEN.ascx.vb" Inherits="vistas_NV_NVLMOEN" %>
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>MOTIVOS NO ENTREGA</h4>
                <div class="actions">
...
<script type="text/javascript" src="../vistas/NV/js/NVLMOEN.js"></script>
<script>
