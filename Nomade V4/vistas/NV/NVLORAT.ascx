<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVLORAT.ascx.vb" Inherits="vistas_NV_NVLORAT" %>
<style>
    @media print {
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>GESTIÓN ORDENES DE ATENCIÓN</h4>
                <div class="actions">
                    <%--<a class="btn black" onclick="javascript:imprimirListaOrdenesAtencion();"><i class="icon-print"></i>&nbsp;Imprimir</a>--%>
                    <%--<a class="btn green" href="?f=nvmdocv"><i class="icon-plus"></i>&nbsp;Nuevo</a>--%>
                    <a class="btn red" href="?f=NVLORAT"><i class="icon-list"></i>&nbsp;Listar</a>
                </div>
            </div>
            ...
            <div class="portlet-body">
                        ...
                        <div class="control-group ">
                            <div class="controls">
                                <select id="cboEstado" class="span12" data-placeholder="Estado">
                                    ...
                                    <option value="X">APLICADO</option>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <table id="tblAtenciones" class="display DTTT_selectable" style="display: none;">
                            <thead>
                                <tr>
                                     <th>NRO. ATENCIÓN
                                    </th>
...
<script type="text/javascript" src="../vistas/NV/js/NVLORAT.js"></script>
<script>
