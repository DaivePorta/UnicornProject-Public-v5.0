<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVLCSER.ascx.vb" Inherits="vistas_NV_NVLCSER" %>
<style>
    .fondoHeader {
    ...
    <div class="span12">
        ...
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>CATÁLOGO SERVICIOS</h4>
                <div class="actions">
            ...
            <div class="portlet-body">
                            ...
                            <div class="span4 offset2">
                                <div class="control-group">
                                    <label class="control-label" for="chkEstado">
                                        ...
                                        Incluir servicios descontinuados</label>
                                </div>
                            </div>
                ...
                <div class="row-fluid">
                    <div class="span12" id="divTblProductos">
                        ...
                        <table id="tblProductos" class="table" style="width: 100%; border: 1px solid #cbcbcb; margin-top: 2%;" cellpadding="7px">
                            <thead class="fondoHeader">
                                <tr>
                                    <th class="center">NOMBRE SERVICIO</th>
        ...
        <div class="span12" style="padding: 1%;">
            <div class="row-fluid">
                ...
                <div class="span4">
                    ...
                    <div class="row-fluid">
                        <div class="span12" id="divTblAlmacenes" style="display:none;">
...
<script type="text/javascript" src="../vistas/NV/js/NVLCSER.js"></script>
<script>
