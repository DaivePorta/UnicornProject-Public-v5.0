<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVMDOCV.ascx.vb" Inherits="vistas_NV_NVMDOCV" %>
<style type="text/css">
    #divMail, #divBuscarDoc, #divWhatsapp, #divLetras, #divAnticipos,#mapaModal {
    ...
    <div class="span12">
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>DOCUMENTO VENTA</h4>
                <div class="actions">
                                        ...
                                        <div class="span12" style="margin-left: 0" id="documentosadd">
                                            <div class="span12" id="div_mas_dctoreg_0" style="margin-left: 0">
                                                ...
                                                <div class="span3">
                                                    <div class="control-group">
                                                        <div class="controls">
                                                            <input id="txt_cod_doc_orig" class="txt_cod_doc_orig" type="hidden" />
                                                            <input id="txt_num_ser_orig" class="numeros txt_num_ser_orig span4" type="text" disabled style="text-align: center" />
                                                            <input id="txt_num_doc_orig" class="numeros txt_num_doc_orig span8" type="text" disabled style="text-align: center; margin-left: -2px;" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="span2">
                                                    <div class="control-group">
                                                        <div class="controls">
                                                            <a id="btnBuscadocs" class="btn blue buscar"><i class="icon-search" style="line-height: initial;"></i></a>
                                                            <a id="btn_add_dcto2" class="btn green add" style="display: none;"><i class="icon-plus" style="line-height: initial;"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
