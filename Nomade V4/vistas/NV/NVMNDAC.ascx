<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVMNDAC.ascx.vb" Inherits="vistas_NV_NVMNDAC" %>
<style>
        ...
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                ...
                <div class="actions">
                    ...
                    <a href="?f=NVMNDAC" class="btn green"><i class="icon-plus"></i>&nbsp;Nuevo</a>
...
<script type="text/javascript" src="../vistas/NV/js/NVMNDAC.js"></script>
<script>
