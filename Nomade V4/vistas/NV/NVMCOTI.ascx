<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVMCOTI.ascx.vb" Inherits="vistas_NV_NVMCOTI" %>
<style>

    #divMail,#divBuscarDoc,#divWhatsapp,#modalPlantilla,#modal-confirmar {
        margin-left:0px !important;
    }

    @media (max-width:900px){      

        #divWhatsapp,#divMail,#divBuscarDoc,#modalPlantilla,#modal-confirmar {
            left:5% !important; 
            width:90% !important;
        }
    }
    ...
    <div class="span12">
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>&nbsp;COTIZACIÓN A CLIENTE</h4>
                <div class="actions">
                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="span8">
                                            ...
                                            <div class="span4 offset1">
                                                <div class="control-group">
                                                    <div class="controls">
                                                        ...
                                                        <input class="numeros span4" id="txtSerieCotizacion" type="text" disabled="disabled" placeholder="Serie" />
                                                        <input class="numeros span8" id="txtNroCotizacion" type="text" disabled="disabled" style="text-align: center; margin-left: -2px;" placeholder="Nro." />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="control-group">
                                                        <div class="controls">
                                                            <select id="cboDctoOrigen" class="span12" data-placeholder="Doc. Origen">
                                                                ...
                                                                <option value="P0053">PLANTILLA COTIZACION</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="span5">
                                                    <div class="control-group">
                                                        <div class="controls">
                                                            ...
                                                            <label class="control-label" id="nombre_plantilla" style="font-size:10px; text-align:left;"></label>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="portlet box blue">
                                            <div class="portlet-title">
                                                <h4><i class="icon-tag"></i>DETALLES DE COTIZACIÓN</h4>
                                            </div>
                                            <div class="portlet-body">
                                                    ...
                                                    <div id="divAgregarProducto">
                                                        ...
                                                        <div class="row-fluid">
                                                            ...
                                                            <div class="span11">
                                                                <div class="control-group">
                                                                    <div class="controls">
                                                                        <textarea id="txt_glosa_det" class="span12" maxlength="100" style="resize: vertical;"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
...
<script type="text/javascript" src="../vistas/NV/js/NVMCOTI.js"></script>
