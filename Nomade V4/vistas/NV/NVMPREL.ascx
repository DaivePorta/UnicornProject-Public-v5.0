<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVMPREL.ascx.vb" Inherits="vistas_NV_NVMPREL" %>
    ...
    <div class="span12">
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>&nbsp;MANTENIMIENTO PRECIOS CLIENTE</h4>
                <div class="actions">
            ...
            <div class="portlet-body">
                    ...
                    <div class="span3">
                        ...
                        <div class="row-fluid">
                             <div class="span8">
                                <div class="control-group">
                                    <div class="controls">
                                        <select id="cboRangoUti" class="span12" data-placeholder="Lista de clientes">
                                            <option value=""></option>
                                        </select>
                                    </div>
                                </div>
                ...
                <div class="row-fluid divUtilDirectas">                    
                    ...
                    <div class="span1">
                        <div class="control-group">
                            <label class="control-label" for="cboRango">Precio x Lista Cliente.</label>
                        </div>
                    </div>
...
<script type="text/javascript" src="../vistas/NV/js/NVMPREL.js"></script>
