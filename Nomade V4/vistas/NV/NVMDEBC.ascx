<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVMDEBC.ascx.vb" Inherits="vistas_NV_NVMDEBC" %>
<style>
    ...
    <div class="span12">
        ...
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>NOTA DÉBITO CLIENTE</h4>
                <div class="actions">
                    <a id="btnMail" class="btn purple hidden"><i class="icon-envelope"></i>&nbsp;Enviar Mail</a>
                    <a href="javascript: ImprimirDcto();" class="btn black" id="btnImprimirDcto" style="display: none;"><i class="icon-print"></i>&nbsp;Imprimir</a>
                    <a href="?f=NVMDEBC" class="btn green"><i class="icon-plus"></i>&nbsp;Nuevo</a>
                    <a href="?f=NVLDEBC" class="btn red"><i class="icon-list"></i>&nbsp;Listar</a>
                </div>
            ...
            <div class="portlet-body">
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <select id="cboTipoDocumento" class="span12 combobox" data-placeholder="Tipo de documento">
                                    <option></option>
                                    <option value="0003">BOLETA VENTA</option>
                                    <option value="0001">FACTURA</option>
                                    <option value="0007">NOTA DE CREDITO</option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span1 ">
                        <div class="control-group">
                            <div class="controls">
                                <input id="txtMonto" type="text" class="span12" placeholder="Monto" disabled="disabled" />
                            </div>
                        </div>
                    </div>
                ...
                <div id="divAgregarDetalles">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span2">
                            <div class="control-group">
                                <div class="controls">
                                    <input type="text" id="txtPrecioUnitario" class="span12 right" placeholder="P.U." onkeyup="ValidarTotales()" onkeypress="return ValidaDecimales(event,this,3)" />
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript" src="../vistas/NV/js/NVMDEBC.js"></script>
<script>
