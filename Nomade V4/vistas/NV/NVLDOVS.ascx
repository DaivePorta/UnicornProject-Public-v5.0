<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVLDOVS.ascx.vb" Inherits="vistas_NV_NVLDOVS" %>
<style>
    @media print {
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>LISTA DOCUMENTO VENTA RÁPIDA SERVICIOS</h4>
                <div class="actions">
                    <a class="btn black" onclick="javascript:imprimirListaDctosVenta();"><i class="icon-print"></i>&nbsp;Imprimir</a>
                    <a class="btn green" href="?f=nvmdovs"><i class="icon-plus"></i>&nbsp;Nuevo</a>
            ...
            <div class="portlet-body">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span1">
                        <div class="control-group">
                            <label class="control-label" for="cboCompleto">
                                Estado</label>
                        </div>
                    </div>
                    <div class="span3">
                        <div class="control-group ">
                            <div class="controls">
                                <select id="cboCompleto" class="span12" data-placeholder="Estado">
                                    <option value="TODOS">TODOS</option>
                                    <option value="S">COMPLETOS</option>
                    ...
                    <div class="span4">
                        <div class="control-group ">
                            <div class="controls" id="divCboProducto">
                                <select id="cboProducto" class="span12" data-placeholder="Servicio">
                                    <option></option>
                                </select>
                            </div>
                        </div>
...
<script type="text/javascript" src="../vistas/NV/js/NVLDOVS.js"></script>
