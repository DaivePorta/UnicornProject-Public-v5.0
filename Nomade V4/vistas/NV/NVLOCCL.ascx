<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVLOCCL.ascx.vb" Inherits="vistas_NV_NVLOCCL" %>
<style>
    @media print {
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>&nbsp;LISTA ORDEN DE COMPRA CLIENTE</h4>
                <div class="actions">
                    <a class="btn black" onclick="javascript:imprimirListaDctosVenta();"><i class="icon-print"></i>&nbsp;Imprimir</a>
                    <a class="btn green" href="?f=nvmoccl"><i class="icon-plus"></i>&nbsp;Nuevo</a>
                </div>
            </div>
...
<script type="text/javascript" src="../vistas/NV/js/NVLOCCL.js"></script>
<script>
