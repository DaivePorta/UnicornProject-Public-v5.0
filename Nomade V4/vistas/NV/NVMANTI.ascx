<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVMANTI.ascx.vb" Inherits="vistas_NV_NVMANTI" %>
<style type="text/css">
    ...
    <div class="span12">
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>RECEPCIÓN DE ANTICIPOS</h4>
                <div class="actions">
                            ...
                            <div class="tab-pane active" id="datos_generales">
                                <div class="row-fluid">
                                    ...
                                    <div class="span8">
                                            ...
                                            <div class="span3">
                                                <div class="control-group span12">
                                                    <div class="controls pull-right">
                                                        ...
                                                        <a id="btnNuevaPersona" href="?f=NKMGECL" target="_blank" title="Nuevo" class="btn green" style="margin-bottom: 2px;"><i class="icon-plus"></i></a>
                                            ...
                                            <div class="span4">
                                                <div class="control-group">
                                                    <div class="controls" style="height: 30px;">
                                                        <label class="control-label" for="chx_sin_origen">
                                                            <input id="chx_sin_origen" type="checkbox" class="span12" style="opacity: 0;">
                                                            Sin Origen
                                                        </label>                                                        
                                                    </div>
                                                </div>
                                        ...
                                        <div class="span12" style="margin-left: 0" id="div_cotizacion_cliente">
                                            <div class="span2">
                                                <div class="control-group">
                                                    <label class="control-label" for="cboDocumentoVenta">
                                                        Cotización</label>
                                            ...
                                            <div class="span10" >
                                                <div class="control-group">
                                                    <select id="cbo_coti" class="span12" data-placeholder="Cotización Cliente" disabled="disabled">
                                                        <option></option>
                                                    </select>                                                    
                                                </div>
                                            </div>                                            
                                        ...
                                        <div class="span12" style="margin-left: 0">   
                                            <div class="control-group">
                                                <div class="controls" style="height: 30px;">
                                                    <label id="lbl_sin_origen">
                                                        <b><span id="lbltexto_sin_origen"></span></b><span class="simboloMoneda4"></span>&nbsp;<span id="lblmonto_sin_origen"></span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <!-- Detalle de Venta -->
                                        <div class="portlet box blue" id="div_detcoti">
                                            <div class="portlet-title">
                                                <h4><i class="icon-tag"></i>DETALLES DE COTIZACIÓN ORIGEN</h4>
                                            </div>
                                            <div class="portlet-body" >

                                                <div class="row-fluid" id="form_datos">
                                                    <div class="row-fluid">
                                                ...
                                                <%--<div class="row-fluid" id="form_add_prod" style="visibility:hidden" >
                                                    ...
                                                    <div class="span8">
                                                        <div class="row-fluid">
                                                            <div class="span4 offset1">
                                                                <div class="control-group">
                                                                    <h1>
                                                                        <label class="control-label" for="txt_glosa" style="font-family: monospace;" id="lbl_visual">
                                                                            <b>TOTAL PENDIENTE COTIZACIÓN:</b>
                                                                        </label>
                                                                    </h1>
                                                                </div>
                                                            </div>
                                        ...
                                        <!-- Antecipos Anteriores -->
                                        <div class="span12" id="p_Anteriores" style="margin-left: 0">
	                                        <div class="portlet box blue">
		                                        <div class="portlet-title" style="cursor: pointer;">
			                                        <h4><i class="icon-chevron-down"></i>Anticipos Anteriores </h4>                                                        
		                                        </div>
                                                <div class="portlet-body">
                                                    <div class="row-fluid">
                                                        <div class="span12" id="div_anteriores">
                                                            <!--Aquí se carga el contenido por jquery-->
                                                        </div>
                                                    </div>                                                    
                                                </div>                                                
                                    ...
                                    <div class="span4">                                        
                                        ...
                                        <!-- Datos de Crédito-->
                                        <div class="span12" id="p_DatCredito" style="margin-left: 0;display:inline">
                                                    ...
                                                    <div class="row-fluid">
                                                        <div class="span12" style="margin-left: 0">
                                                            ...
                                                            <div class="span6">
                                                                <div class="control-group">
                                                                    <div class="controls">
                                                                        <span class="simboloMoneda2"></span>
                                        ...
                                        <div class="span12" id="p_DatCobro" style="margin-left: 0">
                                            <div class="portlet box blue">
                                                <div class="portlet-title" style="cursor: pointer;">
                                                    <h4><i class="icon-chevron-down"></i>Cobro de Anticipo <small id="msgCobro" style="font-style: italic; color: white;"></small></h4>
                                                </div>
                                                <div class="portlet-body">
                                                            ...
                                                            <div class="control-group">
                                                                <div class="controls">
                                                                    <select id="cbo_OrigenPago" class="span12 obligatorio" data-placeholder="ORIGEN DE COBRO">
                                                                        ...
                                                                        <option value="Debe">POR COBRAR</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row-fluid" id="ocultar1">
                                                        <div class="span4">
                                                    ...
                                                    <div class="row-fluid" id="ocultar2">
                                                        <div class="span4">
                                                    ...
                                                    <div class="row-fluid" id="ocultar3">
                                                        <div class="span4">
                                                    ...
                                                    <div class="row-fluid">
                                                        <div class="span4" >
                                                            <div class="control-group">
                                                                <label class="control-label" for="cbo_moneda2">
                                                                    Moneda</label>
                                                            </div>
                                                        </div>
                                                        <div class="span8" >                                                            
                                                            <div class="control-group">
                                                                <div class="controls" id="input_moneda2">
                                                                    <select id="cbo_moneda2" class="span12" data-placeholder="Moneda">
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="row-fluid">
                                    <div class="span12" id="p_monetarios" style="margin-left: 0">
                                        <div class="portlet box green">
                                            <div class="portlet-title">
                                                <h4><i class="icon-money"></i>Datos Monetarios de Pago</h4>
                                            </div>
                                            <div class="portlet-body">
                                                    ...
                                                    <div class="span12">
                                                        ...
                                                        <div class="span1">
                                                            <div class="control-group">
                                                                ...
                                                                <%--<label class="control-label" for="txt_impuesto">
                                                                    (<span id="simboloMoneda3"></span>)
                                                                </label>
                                                                
                                                                <label class="control-label" for="txt_impuesto">)</label>--%>
                                                            </div>
                                                        </div>
                                                        <div class="span2">
                                                            <div class="control-group">
...
<input id="txtEfectivo" type="hidden"  value="0.00"/><!-- Porta -->
<input  id="txtVuelto" type="hidden" value="0.00"/><!-- Porta-->
...
<input id="hfmontorestadetraccion" type="hidden" value="0" />
<input id="hfmontagrup" type="hidden" value="0" />
<input id="hfrelacion" type="hidden" value="1.0" />
