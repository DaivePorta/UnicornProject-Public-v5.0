<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVLDOCS.ascx.vb" Inherits="vistas_NV_NVLDOCS" %>
<style>
    @media print {
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                ...
                <div class="actions">
                    ...
                    <a class="btn green" href="?f=nvmdocs"><i class="icon-plus"></i>&nbsp;Nuevo</a>
...
<script type="text/javascript" src="../vistas/NV/js/NVLDOCS.js"></script>
