var NVLUNVE = function () {
    ...
    var crearTablaVacia = function () {
        var parms = {
            ...
            columns: [
                    ...
                    {
                        data: "UNME", createdCell: function (td, cellData, rowData, row, col) { $(td).attr("align", "center"); }, visible: false
            ...
            drawCallback: function (settings) {
                ...
                api.column(5, { page: 'current' }).data().each(function (group, i) {                  
                    ...
                    if (last !== group ) {
                        ...
                        if (last !== null) {
                            $("#tr_" + last.split(" ").join("_").split("(")[0]).html('<td colspan="2" style="border:solid #AAAAAA 2px">' + last + '</td><td style="border:solid #AAAAAA 2px" colspan="2">CANTIDAD TOTAL:<span style="float:right;">' + formatoMiles(totalUnidades) + '</span></td><td colspan="3" style="border:solid #AAAAAA 2px">MONTO TOTAL:<span style="float:right;">' + smoneda + formatoMiles(totalMonto) + '</span></td>');
                    ...
                    if (api.column(5, { page: 'current' }).data().length - 1 == i) {
                        $("#tr_" + group.split(" ").join("_").split("(")[0]).html('<td colspan="2" style="border:solid #AAAAAA 2px">' + group + '</td><td style="border:solid #AAAAAA 2px" colspan="2">CANTIDAD TOTAL:<span style="float:right;">' + formatoMiles(totalUnidades) + '</span></td><td colspan="3" style="border:solid #AAAAAA 2px">MONTO TOTAL:<span style="float:right;">' + smoneda + formatoMiles(totalMonto) + '</span></td>');
                        texto.push(last + "," + totalUnidades + "," + smoneda + totalMonto.Redondear());
                    }
    ...
    function cargainicial() {
        ...
        $('#btnMail').click(function (e) {
            ...
            $('#txtAsunto').val("REPORTE UNIDADES VENDIDAS - " + $("#cboEstablecimiento :selected").html());
...
function imprimirTotales() {
    ...
    a.download = "REPORTE_UNIDADES_VENDIDAS_" + $("#cboEstablecimiento :selected").html() + ".csv";
    a.click();
