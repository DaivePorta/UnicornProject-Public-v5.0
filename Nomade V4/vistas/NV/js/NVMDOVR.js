...
function cargarParametrosSistema() {
    let filtro = "DIGC,DIGP,STKP,REDN,DETR,RETN,RETR,IMRE,BFDV,ODON,VNST,ADET,ACON,CURS,MIGO,GRAN"; //Aquí van los parámetros que se van a utilizar en la pantalla y luego se le hace su case
