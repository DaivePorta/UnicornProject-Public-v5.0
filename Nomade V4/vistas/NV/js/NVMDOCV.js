                        ...
                        success: function (datos2) {
                            ...
                            if (datos2 != null) {
                                ...
                                for (var i = 0; i < datos2.length; i++) {
                                    ...
                                    //pruebita DPORTA
                                    cod_cate_clie = datos2[i].CAT_CODE;
...
function cargarParametrosSistema() {
    let filtro = "DIGC,DIGP,STKP,REDN,DETR,RETN,RETR,IMRE,BFDV,ODON,VNST,ADET,ACON,CURS,MIGO,CANT,0021,CLIE"; //Aquí van los parámetros que se van a utilizar en la pantalla y luego se le hace su case
