...
var NVLDOCS = function () {
    ...
    var obtenerDocumentos = function () {
        ...
        var jqxhr = $.ajax({
            type: "POST",
            url: "vistas/nv/ajax/nvmdovs.ashx?OPCION=LDVSERV",
            contentType: false,
            data: data,
            processData: false,
            cache: false
           ...
           if (datos != null) {
               ...
               $('#tblDocumento').on('dblclick', 'tr', function () {
                   if ($(this).hasClass('selected')) {
                       ...
                       var code = row[0];
                       window.open("?f=nvmdocs&codigo=" + code, '_blank');
                   }
               });
    ...
    var jqxhr = $.ajax({
        ...
        success: function (datos) {
            ...
            if (datos != null) {
                ...
                $("#divDctoImprimir").prepend("<h5 class='arial'>DOCUMENTOS DE VENTA SERVICIOS - " + nomSucursal + "</h5>")
