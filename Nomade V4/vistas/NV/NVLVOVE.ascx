<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVLVOVE.ascx.vb" Inherits="vistas_NV_NVLVOVE" %>
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>VOLUMEN VENDIDO</h4>
                <div class="actions">
...
<script type="text/javascript" src="../vistas/NV/js/NVLVOVE.js"></script>
<script>
