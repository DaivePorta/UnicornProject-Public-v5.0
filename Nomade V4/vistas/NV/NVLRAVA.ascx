<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVLRAVA.ascx.vb" Inherits="vistas_NV_NVLRAVA" %>
    ...
    <div class="span12 ">
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>REPORTE DE ANALÍTICO DE VENTAS ANUALES</h4>
                <div class="actions">
...
<script type="text/javascript" src="../vistas/NV/js/NVLRAVA.js"></script>
<script>
