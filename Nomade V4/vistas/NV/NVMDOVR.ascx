    <%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVMDOVR.ascx.vb" Inherits="vistas_NV_NVMDOVR" %>
<style type="text/css">
    #divMail, #divWhatsapp, #divAnticipos, #mapaModal {
                                            ...
                                            <div class="portlet-body">
                                                ...
                                                <div class="row-fluid" id="form_add_prod">
                                                    ...
                                                    <div id="divAgregarProducto">
                                                        <div class="row-fluid">
                                                            ...
                                                            <div class="span4" id="divCboAlmacen">
                                                                <div class="control-group">
                                                                    <div class="controls">
                                                                ...
                                                                <div class="span7">
                                                                    <div class="control-group">
                                                                        <div class="controls" id="input_desc_prod">
                                                                            <input id="txt_desc_producto" class="span12" type="text" placeholder="Descripción de Producto o Servicio" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="span1">
                                                        ...
                                                        <div class="row-fluid">
                                                            ...
                                                            <%--<div class="span1" id="divlblStock">
                                                             <div class="control-group">
                                                                    <label class="control-label"  for="txtPrecioUnitario" style="text-align: right; color: black;">
                                                                        Stock Venta</label>
                                                                </div>
                                                            </div>--%>
                                                            <%--<div class="span1" id="divtxtSotock">
                                                             <div class="control-group">
                                                                 <div class="controls" id="divStockVenta">
                                                                     <input id="txtStockVenta" class="span12" type="text" disabled="disabled"/>
                                                                 </div>
                                                             </div>
                                                            </div>--%>
                                                           </div>
                                                            ...
                                                            <div class="span8">
                                                                <div class="control-group">
                                                                    <div class="controls">
                                                                        <textarea id="txt_glosa_det" class="span12" maxlength="1000" style="resize: vertical; max-height: 120px;"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row-fluid" style="margin-top: 15px;">
                                                    ...
                                                    <div class="span8 ">
                                                        ...
                                                        <!-- GRAN REDONDEO -->
                                                        <div class="span6" id="div_gran_redondeo">
                                                            <div class="span8 ">
                                                                <div class="control-group">
                                                                    <div class="controls">
                                                                        <label class="radio pull-right">
                                                                            <div class="radio disabled">
                                                                                <span>
                                                                                    <input type="checkbox" style="opacity: 0;" name="granRedondeo" id="rbGranRedondeo" disabled="disabled" />
                                                                                </span>
                                                                            </div>
                                                                            Gran Redondeo
                                                                        </label>
                                                            ...
                                                            <div class="span4">
                                                                <div class="control-group">
                                                                    <div class="controls">
                                                                        <input id="txtGranRedondeo" class="span12" type="text" disabled="disabled" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="span4">
                                        ...
                                        <div class="span12" id="p_DatTributaciones" style="margin-left: 0">
                                            <div class="portlet box yellow">
                                                <div class="portlet-title" style="cursor: pointer;">
                                                    <h4><i class="icon-chevron-up"></i>Tributaciones</h4>
                                                </div>
                                        ...
                                        <div class="span12" id="p_DatCobro" style="margin-left: 0">
                                            <div class="portlet box blue" style="margin-bottom: 10px">
                                                <div class="portlet-title" style="cursor: pointer;">
                                                    <h4><i class="icon-chevron-down"></i>Cobro de Venta 1<small id="msgCobro" style="font-style: italic; color: white;">*Obligatorio</small></h4>
                                                </div>
                                                <div class="portlet-body">
                                                ...
                                                <div class="portlet-body" style="display: none;">
                                                    ...
                                                    <%--<div class="row-fluid">
                                                        ...
                                                        <div class="span6">
                                                            <div class="control-group">
                                                                <div class="controls">
                                                                    <input type="text" class="span12 date-picker obligatorio" placeholder="dd/mm/yyyy" id="txtFechaPago3" data-date-format="dd/mm/yyyy" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>--%>
...
<input id="txtStockVenta2" type="hidden" disabled="disabled"/><%--DPORTA--%>
...
<div id="modal-habido" class="modal hide">
    ...
    <div class="modal-body">
        ...
        <div class="row-fluid" style="margin-top: 10px;">
            <%--<div class="span4" style="margin-left:9%;">
                <div class="span12">
...
<script type="text/javascript" src="../vistas/NV/js/NVMDOVR.js"></script>
