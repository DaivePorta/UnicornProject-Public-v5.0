<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVLDOVR.ascx.vb" Inherits="vistas_NV_NVLDOVR" %>
<style>
    @media print {
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>LISTA DOCUMENTO VENTA RÁPIDA</h4>
                <div class="actions">
...
<script type="text/javascript" src="../vistas/NV/js/NVLDOVR.js"></script>
