<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVLNDDP.ascx.vb" Inherits="vistas_NV_NVLNDDP" %>
<style>
    ...
    <div class="span12">
        ...
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>LISTA NOTA DE DÉBITO DE PROVEEDOR</h4>
                <div class="actions">
