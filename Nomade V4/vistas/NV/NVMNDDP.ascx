<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NVMNDDP.ascx.vb" Inherits="vistas_NV_NVMNDDP" %>
<style>
    ...
    <div class="span12">
        ...
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>NOTA DE DÉBITO DE PROVEEDOR</h4>
                <div class="actions">
                    <%--<a id="btnMail" class="btn purple"><i class="icon-envelope"></i>&nbsp;Enviar Mail</a>--%>
                    <%--<a class="btn black printlist"><i class="icon-print"></i>&nbsp;Imprimir</a>--%>
                    <a href="?f=NVMNDDP" class="btn green"><i class="icon-plus"></i>&nbsp;Nuevo</a>
                    <a href="?f=NVLNDDP" class="btn red"><i class="icon-list"></i>&nbsp;Listar</a>
                </div>
            ...
            <div class="portlet-body">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span1 offset1">
                        <div class="control-group">
                            <label id="lblSerieNota" class="control-label" for="txtSerieNota">
                                Serie</label>
                        </div>
                    </div>
                    <div class="span1">
                        <div class="control-group">
                            <div class="controls">
                                <input id="txtSerieNota" onkeypress='return ValidaNumeros(event,this)' maxlength="5" class="span12" type="text" placeholder="Serie" title="Serie Nota de Débito" />
                            </div>
                        </div>
                    </div>
                    <div class="span1">
                        <div class="control-group">
                            <label id="lblNroNota" class="control-label" for="txtNroNota">
                                Nro.</label>
                        </div>
                    </div>
                    <div class="span2">
                        <div class="control-group">
                            <div class="controls">
                                <input id="txtNroNota" onkeypress='return ValidaNumeros(event,this);' maxlength="9" class="span12" type="text" placeholder="Nro"  title="Número Nota de Débito" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span4">
                        <div class="control-group">
                            <div class="controls">
                                <select id="cboMotivo" class="span12" data-placeholder="Motivo o Sustento">
                                    <option value=""></option>
                        ...
                        <div class="span2">
                            <div class="control-group">
                                <div class="controls" id="divUnidadMedida">
                                    <select id="cboUnidadMedida" class="span12" data-placeholder="U. Medida">
                                        <option></option>
                                    </select>
                                </div>
                            </div>
...
<script type="text/javascript" src="../vistas/NV/js/NVMNDDP.js"></script>
<script>
