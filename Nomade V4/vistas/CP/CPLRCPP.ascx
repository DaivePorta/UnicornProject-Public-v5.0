<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CPLRCPP.ascx.vb" Inherits="vistas_CP_CPLRCPP" %>
...
<script type="text/javascript" src="../vistas/CP/js/CPLRCPP.js"></script>
<script>
