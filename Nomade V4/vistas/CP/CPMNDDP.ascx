<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CPMNDDP.ascx.vb" Inherits="vistas_CP_CPMNDDP" %>
<style>
        ...
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                ...
                <div class="actions">
                    ...
                    <a href="?f=CPMNDDP" class="btn green"><i class="icon-plus"></i>&nbsp;Nuevo</a>
                    <a href="?f=CPLNDDP" class="btn red"><i class="icon-list"></i>&nbsp;Listar</a>
                </div>
            ...
            <div class="portlet-body">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span1">
                        <div class="control-group">
                            <div class="controls">
                                <input id="txtSerieNota" onkeypress='return ValidaNumeros(event,this)' maxlength="4" class="span12" type="text" placeholder="Serie"  title="Serie Nota de Débito" />
                            </div>
                        </div>
                    </div>
                    <div class="span1">
...
<script type="text/javascript" src="../vistas/CP/js/CPMNDDP.js"></script>
<script>
