...
var CPLRACR = function () {
    ...
    var cargarFechaDefecto = function () {
        ...
        if (typeof $('#cboMes').val() != "undefined" && typeof $('#txtanio').val() != "undefined") {
            cargarDatos();
            setTimeout(function () {
                cargarGrafico("contenedor", "Análisis De Créditos A Proveedores", $("#cboMes option:selected").html() + " - " + $("#txtanio").val(), "tblDatos");
            }, 250);
        }
    }
    ...
    var cargarDatos = function () {
        ...
        var jqxhr = $.ajax({
            type: "POST",
            url: "vistas/CP/ajax/CPLRACR.ASHX",
            contentType: false,
            data: data,
            processData: false,
            cache: false,
