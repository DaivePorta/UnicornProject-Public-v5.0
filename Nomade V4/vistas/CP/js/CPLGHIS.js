var CPLGHIS = function () {
    ...
    var fillCboEmpresa = function () {
        $.ajax({
            type: "post",
            url: "vistas/cp/ajax/CPLGHIS.ashx?OPCION=0&p_USUA_ID=" + $('#ctl00_txtus').val(),
    ...
    var obtenerReporteCuentasPorPagar = function () {
        ...
        data.append('p_DIAS_RETRASO', $("#txtDiasRetraso").val());

        Bloquear("ventana");
        var jqxhr = $.ajax({
            type: "POST",
            url: "vistas/cp/ajax/CPLGHIS.ashx?OPCION=1",
            contentType: false,
            data: data,
            processData: false,
            cache: false
