var CPLRDAT = function () {
    var plugins = function () {
        $("#cboEmpresa").select2();
        $("#tblDeudasAtrasadas").DataTable();
    ...
    var fillCboEmpresa = function () {
        $.ajax({
            type: "post",
            url: "vistas/cp/ajax/cplrdat.ashx?OPCION=0&p_USUA_ID=" + $('#ctl00_txtus').val(),
    ...
    var obtenerReporteDeudasAtrasadas = function () {
        ...
        var jqxhr = $.ajax({
            type: "POST",
            url: "vistas/cp/ajax/cplrdat.ashx?OPCION=1",
            contentType: false,
            data: data,
            processData: false,
            cache: false
       ...
       .success(function (datos) {
           ...
           if (datos != null) {
               ...
               oTableTReg = $("#tblDeudasAtrasadas").dataTable({
               ...
               $('#tblDeudasAtrasadas').DataTable().columns(0).visible(false);
               $('#tblDeudasAtrasadas tbody').on('dblclick', 'tr', function () {                   
