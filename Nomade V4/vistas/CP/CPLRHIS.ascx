<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CPLRHIS.ascx.vb" Inherits="vistas_CP_CPLRHIS" %>
<style>
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4>
                    <i class="icon-reorder"></i>REPORTE HISTÓRICO PROVEEDOR</h4>
                <div class="actions">
...
<script type="text/javascript" src="../vistas/CP/js/CPLRHIS.js"></script>
<script>
