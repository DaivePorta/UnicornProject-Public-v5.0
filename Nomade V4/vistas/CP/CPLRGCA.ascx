<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CPLRGCA.ascx.vb" Inherits="vistas_CP_CPLRGCA" %>
<style>
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4>
                    <i class="icon-reorder"></i>REPORTE CUENTAS DIVERSAS C/AMORTIZACIONES</h4>
                <div class="actions">
...
<script type="text/javascript" src="../vistas/CP/js/CPLRGCA.js"></script>
