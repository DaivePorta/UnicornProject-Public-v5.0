<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CPLGAME.ascx.vb" Inherits="vistas_CP_CPLGAME" %>
<style>
    #tblRegistroGastos {
        max-width: 3000px;
        width: 2570px;
    ...
    <div class="span12 ">
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4>
                    <i class="icon-reorder"></i>RESUMEN DE GASTOS POR MESES</h4>
                <div class="actions">
            ...
            <div class="portlet-body">
                ...
                <div class="row-fluid">                    
                    ...
                    <div class="span2">
                        <div class="control-group">
                            <div class="controls">
                                <select id="cboClasificacion" class="span12" data-placeholder="MES">
                                    <option value="CG">CONCEPTO</option>
                                    <option value="SCG">SUB CONCEPTO</option>
                    ...
                    <asp:HiddenField ID="hddClasificacion" runat="server" />
                    <asp:HiddenField ID="hddDesClasificacion" runat="server" />
                </div>
                <br>
                <br>
                <div class="row-fluid">
...
<script type="text/javascript" src="../vistas/CP/js/CPLGAME.js"></script>
<script>
