<%@ WebHandler Language="VB" Class="CPLRGPE" %>

Imports System
Imports System.Web
Imports System.Data

Public Class CPLRGPE : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Try
            ...
            Select Case OPCION
                ...
                Case "1" 'REPORTE DE CUENTAS DIVERSAS POR PERSONA
                    context.Response.ContentType = "application/text; charset=utf-8"
                    dt = cpPagosDiversos.ListarCuentasDiversasPorPersona(p_CTLG_CODE, p_PIDM, Utilities.fechaLocal(p_DESDE), Utilities.fechaLocal(p_HASTA), "N")
