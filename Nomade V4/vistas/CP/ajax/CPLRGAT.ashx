<%@ WebHandler Language="VB" Class="CPLRGAT" %>

Imports System
Imports System.Web
Imports System.Data

Public Class CPLRGAT : Implements IHttpHandler
        ...
        Try
            ...
            Select Case OPCION
                ...
                Case "1" 'reporte de cuentas por pagar
                    ...
                    dt = cpPagosDiversos.ListarCuentasDiversasAtrasadasPorPagar(p_CTLG_CODE)
    ...
    Public Function GenerarTablaDeudasAtrasadas(ByVal dt As DataTable) As String
        ...
        '------        
        resb.AppendFormat("<table id=""tblDeudasAtrasadas"" class=""display DTTT_selectable"" border=""0"">")
        resb.AppendFormat("<thead>")
        resb.AppendFormat("<th>PERSONA</th>")
