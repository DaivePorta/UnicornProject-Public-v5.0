<%@ WebHandler Language="VB" Class="CPLDEPR" %>
        ...
        Try
            ...
            Select Case OPCION
                Case "0" 'lista empresas
                    ...
                    End If
                    res = resb.ToString()
                Case "1" 'lista reporte de deudas con proveedor , para el caso de letras: muestra las letras no pagadas, pero que se han canjeado
                    context.Response.ContentType = "application/text; charset=utf-8"
                    dt = cpCuentaPorPagar.ListarDeudasConProveedor(p_CTLG_CODE, "N", "A", p_PROV_PIDM)
