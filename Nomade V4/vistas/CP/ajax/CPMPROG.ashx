<%@ WebHandler Language="VB" Class="CPMPROG" %>

Imports System
Imports System.Web
Imports System.Data

Public Class CPMPROG : Implements IHttpHandler
    ...
    Dim ccCuentaPorPagar As New Nomade.CP.CPCuentaPorPagar("Bn")
        ...
        Try
            ...
            Select Case OPCION
                Case "0" 'lista empresas
                    ...
                    End If
                    res = resb.ToString()
                Case "1" 'lista eventos pago
                    context.Response.ContentType = "application/text; charset=utf-8"
                    dt = ccCuentaPorPagar.ListarDeudasPagarProveedor(p_CTLG_CODE, "N", "A", "0", IIf(p_SCSL_CODE Is Nothing, String.Empty, p_SCSL_CODE))
                    If Not (dt Is Nothing) Then
                        resb.Append("[")
                        For Each MiDataRow As DataRow In dt.Rows
                            resb.Append("{")
                    ...
                    End If
                    res = resb.ToString()
                Case "2" 'Grabar postergación de cobranza y actualizar fecha de pago del documento
                    Dim msg As Array
                    msg = ccCuentaPorPagar.CrearActualizacionPago(p_DCTO_TIPO, p_DCTO_CODE, p_CTLG_CODE, p_SCSL_CODE, p_FECHA_ANTERIOR, p_FECHA_COBRANZA, p_DCTO_TIPO, p_USUA_ID)
                    res = msg(0)
