  <%@ WebHandler Language="VB" Class="CPMPGCB" %>
...
Public Class CPMPGCB : Implements IHttpHandler
    ...
    Dim establec As String
    Dim fini As String
    Dim ffin As String
    Dim PAGADO_IND As String
    Dim scsl As String
        ...
        Try
            ...
            Select Case flag.ToString()
                ...
                Case "1" 'crear pago x caja
                    res = PagoCredito.PagoCreditoCaja(detalle, caja, usuario, codigo_apertura, empresa, fecha_pago, moneda, medio_pago, descripcion, destino, documento, tipo_cambio, PAGADO_IND, scsl, "CAJ", "", "", "", "", "", adicional, monto_total)

                Case "1.5" 'crear pago x banco
                    res = PagoCredito.PagoCreditoBanco(detalle, pidmcuenta, cuenta, usuario, empresa, fecha_pago, moneda, medio_pago, descripcion, destino, documento, completo, monto_total, tipo_cambio, PAGADO_IND, scsl, adicional, caja)
                ...
                Case "4"
                    dt = cpCuentaPorPagar.ListarDeudasConProveedor(empresa, "N", "A", proveedor, establec, Utilities.fechaLocal(fini), Utilities.fechaLocal(ffin))
                ...
                Case "L"
                    ...
                    '    dt = PagoCredito.ListarPagosProveedores(empresa, establec, proveedor, Utilities.fechaLocal(fini), Utilities.fechaLocal(ffin))
                    If Not dt Is Nothing Then
