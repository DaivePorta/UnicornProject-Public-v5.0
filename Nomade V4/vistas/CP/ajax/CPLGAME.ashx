<%@ WebHandler Language="VB" Class="CPLGAME" %>
...
Public Class CPLGAME : Implements IHttpHandler

    Dim OPCION As String
    Dim p_CTLG_CODE, p_SCSL_CODE, p_CLASIFICACION, p_ANIO, p_DESC_EMPRESA, p_DESC_CLASIFICACION As String
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        p_CLASIFICACION = context.Request("p_CLASIFICACION")
        p_ANIO = context.Request("p_ANIO")
        p_DESC_EMPRESA = context.Request("p_DESC_EMPRESA").Replace("&amp;", "Y")
        p_DESC_CLASIFICACION = context.Request("p_DESC_CLASIFICACION")
        ...
        Try
            ...
            Select Case OPCION
                Case "1" 'Generar tabla: Libro 8 en interfaz
                    ...
                    res = GenerarTablaResumenGastos(dt).ToString()
    ...
    Public Function GenerarPDF(ByVal dt As DataTable) As String
        ...
        cNomArch = "RESUMEN DE GASTOS DE " + p_DESC_EMPRESA.ToString + " POR " + p_DESC_CLASIFICACION + "_" + p_ANIO + ".pdf"

        htmlText = GenerarTablaResumenGastos(dt)
    ...
    Public Function GenerarTablaResumenGastos(ByVal dt As DataTable) As StringBuilder
