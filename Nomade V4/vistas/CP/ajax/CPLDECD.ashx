<%@ WebHandler Language="VB" Class="CPLDECD" %>

Imports System
Imports System.Web
Imports System.Data

Public Class CPLDECD : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Try
            ...
            Select Case OPCION
                ...
                Case "1" 'REPORTE DE DEUDAS ACTUALES CON PERSONAS
                    context.Response.ContentType = "application/text; charset=utf-8"
                    dt = cpPagosDiversos.ListarDeudasActualesDiversas(p_CTLG_CODE, "N", "A", p_PIDM)
