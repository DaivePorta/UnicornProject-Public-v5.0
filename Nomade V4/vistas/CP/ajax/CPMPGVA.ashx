  <%@ WebHandler Language="VB" Class="CPMPGVA" %>
...
Public Class CPMPGVA : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Try
            ...
            Select Case flag.ToString()
                ...
                Case "3"
                    dt = PagoProveedor.ListarProveedoresPorPagarGatos(empresa) 'DPORTA 18/03/2021
                    If dt Is Nothing Then
                        res = "<option></option>"
                    Else
                    ...
                    End If
                Case "3.5"
                    dt = PagoProveedor.ListarProveedoresGatos(empresa) 'DPORTA 06/04/2021
                    If dt Is Nothing Then
                        res = "<option></option>"
                    Else
                        res = GenerarSelect(SortDataTableColumn(dt, "razon_social", "ASC"), "pidm", "razon_social", "PROVEEDOR")
                    End If
                Case "4" 'DPORTA 18/03/2021
                    dt = cpCuentaPorPagar.ListarDeudasConProveedorGatos(empresa, "N", "A", proveedor, establec, fini, ffin)
                ...
                Case "L" 'DPORTA 19/03/2021
                    context.Response.ContentType = "application/json; charset=utf-8"
                    dt = PagoProveedor.ListarPagosVariosGastosProveedores(empresa, establec, proveedor, fini, ffin)
                    If Not dt Is Nothing Then
                        resb.Append("[")
                        For Each row As DataRow In dt.Rows
                            resb.Append("{")
                ...
                Case "LA" 'DPORTA 21/03/2021
                    context.Response.ContentType = "application/json; charset=utf-8"
                    dt = cpCuentaPorPagar.Listar_Amortizacion_Gatos(codigo)
                    If Not dt Is Nothing Then
