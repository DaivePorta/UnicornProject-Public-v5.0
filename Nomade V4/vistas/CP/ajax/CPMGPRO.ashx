<%@ WebHandler Language="VB" Class="CPMGPRO" %>

Imports System
Imports System.Web
Imports System.Data

Public Class CPMGPRO : Implements IHttpHandler
        ...
        Try
            ...
            Select Case OPCION
                ...
                Case "1" 'lista eventos pago
                    ...
                    dt = cpPagosDiversos.ListarDeudasPagarDiversas(p_CTLG_CODE, "N", "A", "0")
                    If Not (dt Is Nothing) Then
                        resb.Append("[")
                        For Each MiDataRow As DataRow In dt.Rows
                            resb.Append("{")
                    ...
                    End If
                    res = resb.ToString()
                Case "2" 'GRABAR POSTERGACION DE PAGO Y ACTUALIZAR FECHA DE PAGO DEL DOCUMENTO
                    Dim msg As Array
                    msg = cpPagosDiversos.CrearActualizacionPago(p_DCTO_TIPO, p_DCTO_CODE, p_CTLG_CODE, p_SCSL_CODE, p_FECHA_ANTERIOR, p_FECHA_COBRANZA, p_DCTO_TIPO, p_USUA_ID)
                    res = msg(0)
