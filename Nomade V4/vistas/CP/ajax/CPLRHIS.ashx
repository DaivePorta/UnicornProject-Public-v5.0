<%@ WebHandler Language="VB" Class="CPLRHIS" %>

Imports System
Imports System.Web
Imports System.Data

Public Class CPLRHIS : Implements IHttpHandler
        ...
        Try
            ...
            Select Case OPCION
                Case "0" 'lista empresas
                    ...
                    End If
                    res = resb.ToString()
                Case "1" 'reporte de cuentas por pagar HISTORICO para un proveedor determinado
                    context.Response.ContentType = "application/text; charset=utf-8"
                    dt = cpCuentaPorPagar.ListarCuentasPorPagarPorProveedorHistorico(p_CTLG_CODE, p_PROV_PIDM, Utilities.fechaLocal(p_DESDE), Utilities.fechaLocal(p_HASTA), "", p_SCSL_CODE)
