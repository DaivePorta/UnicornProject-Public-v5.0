<%@ WebHandler Language="VB" Class="CPLRCPR" %>

Imports System
Imports System.Web
Imports System.Data

Public Class CPLRCPR : Implements IHttpHandler

    Dim OPCION, p_CTLG_CODE, p_USUA_ID, p_PROV_PIDM, p_DESDE, p_HASTA As String
    Dim dt As DataTable
        ...
        Try
            ...
            Select Case OPCION
                Case "0" 'lista empresas
                    ...
                    End If
                    res = resb.ToString()
                Case "1" 'reporte de cuentas por pagar para un proveedor determinado
                    context.Response.ContentType = "application/text; charset=utf-8"
                    dt = cpCuentaPorPagar.ListarCuentasPorPagarPorProveedor(p_CTLG_CODE, p_PROV_PIDM, Utilities.fechaLocal(p_DESDE), Utilities.fechaLocal(p_HASTA), "N", p_SCSL)
    ...
    Public Function GenerarTablaCuentaPorPagar(ByVal dt As DataTable) As String
        ...
        resb.AppendFormat("<th>COD. DOCUMENTO</th>")
        ...
        Else
            ...
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                resb.AppendFormat("<td align='center' display: 'none' >{0}</td>", dt.Rows(i)("CODIGO_DOCUMENTO").ToString())

                If dt.Rows(i)("MONE_BASE_IND") = "SI" Then
                    resb.AppendFormat("<td align='center' style= 'background-color: rgb(255, 249, 179);' >{0}</td>", String.Format("{0:#,##0.00}", Decimal.Parse(dt.Rows(i)("MONTO_SOLES").ToString())))
                ...
                Else
                    ...
                    resb.AppendFormat("<td align='center'style= 'background-color: rgb(255, 249, 179);' >{0}</td>", String.Format("{0:#,##0.00}", Decimal.Parse(dt.Rows(i)("MONTO_DOLARES").ToString())))
                End If
