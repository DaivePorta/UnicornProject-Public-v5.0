<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CPLRGAT.ascx.vb" Inherits="vistas_CP_CPLRGAT" %>
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4>
                    <i class="icon-reorder"></i>REPORTE DE CUENTAS DIVERSAS ATRASADAS POR PAGAR</h4>
                <div class="actions">
                    <a href="?f=CPLRGAT" class="btn green " style="margin-top: -10px;"><i class="icon-plus"></i>&nbsp;Nuevo</a>
...
<script type="text/javascript" src="../vistas/CP/js/CPLRGAT.js"></script>
