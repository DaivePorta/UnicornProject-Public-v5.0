<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CPLRGPP.ascx.vb" Inherits="vistas_CP_CPLRGPP" %>
...
<script type="text/javascript" src="../vistas/CP/js/CPLRGPP.js"></script>
<script>
