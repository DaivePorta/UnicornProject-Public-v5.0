<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CPMPGPR.ascx.vb" Inherits="vistas_CP_CPMPGPR" %>
    ...
    <div class="span12 ">
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>CUENTAS POR PAGAR PROVEEDORES</h4>
                <div class="actions">
...
<script type='text/javascript' src='../vistas/CP/js/CPMPGPR.js?<%=aleatorio%>'></script>
