<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CPMPROG.ascx.vb" Inherits="vistas_CP_CPMPROG" %>
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4>
                    <i class="icon-reorder"></i>PROGRAMACIÓN DE PAGOS</h4>
                <div class="actions">
...
<script type="text/javascript" src="../vistas/cp/js/CPMPROG.js"></script>
