<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CPLRGPE.ascx.vb" Inherits="vistas_CP_CPLRGPE" %>
<style>
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4>
                    <i class="icon-reorder"></i>&nbsp;REPORTE CTAS DIVERSAS PERSONA</h4>
                <div class="actions">
                    <a class="btn black printlist" style="margin-top: -10px;"><i class="icon-print"></i>&nbsp;Imprimir</a>
                    <%--<a href="?f=CPLRGPE" class="btn red"><i class="icon-list"></i>Listar</a>--%>
                </div>
...
<script type="text/javascript" src="../vistas/CP/js/CPLRGPE.js"></script>
<script>
