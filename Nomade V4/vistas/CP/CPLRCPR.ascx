<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CPLRCPR.ascx.vb" Inherits="vistas_CP_CPLRCPR" %>
<style>
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4>
                    <i class="icon-reorder"></i>REPORTE CTAS PAGAR PROVEEDOR</h4>
                <div class="actions">
...
<script type="text/javascript" src="../vistas/CP/js/CPLRCPR.js"></script>
<script>
