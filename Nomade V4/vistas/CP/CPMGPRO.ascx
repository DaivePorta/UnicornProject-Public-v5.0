<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CPMGPRO.ascx.vb" Inherits="vistas_CP_CPMGPRO" %>
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4>
                    <i class="icon-reorder"></i>&nbsp;PROGRAMACIÓN DE PAGOS DIVERSOS</h4>
                <div class="actions">
...
<script type="text/javascript" src="../vistas/cp/js/CPMGPRO.js"></script>
