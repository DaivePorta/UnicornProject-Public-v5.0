<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CPLPGVA.ascx.vb" Inherits="vistas_CP_CPLPGVA" %>
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4>
                    <i class="icon-reorder"></i>LISTA PAGOS VARIOS</h4>
                <div class="actions">
...
<script type="text/javascript" src="../vistas/CP/js/CPMPGVA.js"></script>
