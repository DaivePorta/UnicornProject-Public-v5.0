var CCLDECL = function () {
    ...
    var fillCboEmpresa = function () {
        $.ajax({
            type: "post",
            url: "vistas/cc/ajax/ccldecl.ashx?OPCION=0&p_USUA_ID=" + $('#ctl00_txtus').val(),
    ...
    var obtenerReporteCuentasPorCobrar = function () {
        ...
        var jqxhr = $.ajax({
            type: "POST",
            url: "vistas/cc/ajax/ccldecl.ashx?OPCION=1",
            contentType: false,
            data: data,
            processData: false,
            cache: false
       ...
       .success(function (datos) {
           ...
           if (datos != null) {
               ...
               var oTable = $('#tblCuentasPorCobrar').dataTable();
