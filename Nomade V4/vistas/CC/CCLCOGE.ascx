<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CCLCOGE.ascx.vb" Inherits="vistas_CC_CCLCOGE" %>
<style>
    @media print {
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>REPORTE GENERAL DE CUENTAS POR COBRAR A UNA FECHA DETERMINADA</h4>
                <div class="actions">
                    <%--<a class="btn black" onclick="javascript:imprimirListaDctosVenta();"><i class="icon-print"></i>&nbsp;Imprimir</a>--%>
                    <a class="btn red" href="?f=CCLCOGE"><i class="icon-plus"></i>&nbsp;Listar</a>
...
<script type="text/javascript" src="../vistas/CC/js/CCLCOGE.js"></script>
<script>
