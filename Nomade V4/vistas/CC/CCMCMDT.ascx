<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CCMCMDT.ascx.vb" Inherits="vistas_CC_CCMCMDT" %>
    ...
    <div class="span12 ">
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>COBRO MASIVO DE DETRACCIONES</h4>
                <div class="actions">

                    <a href="?f=CCMCMDT" class="btn green"><i class="icon-plus"></i>Nuevo</a>
                    <a href="?f=ccmcbdt" class="btn red"><i class="icon-list"></i>Listar</a>
                </div>
            </div>
            ...
            <div class="portlet-body">
                ...
                <div class="row-fluid master">
                    ...
                    <div class="span1">
                        ...
                        <label>Tipo de Cambio Cliente</label>
                ...
                <div class="row-fluid">
                    <div class="span1">
                        <div class="control-group">
                            <label class="control-label" for="chboAutodetracc">Autodetraccion</label>
                        </div>
                    </div>
                    <div class="span2">
                        <div class="control-group">
                            <div class="controls">
                                <div class="danger-toggle-button-custom">
                                    <input id="chboAutodetracc" type="checkbox" class="toggle" data-valactual="false" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row-fluid">
                            <div class="span10">
                                ...
                                <div style="display: inline-block;">
                                    <img id="imgSustento" style="width: 30px; height: 30px;" src="../../recursos/img/no_disponible.jpg" /></div>
                            </div>
                        </div>
...
<script type='text/javascript' src='../vistas/CC/js/CCMCMDT.js?<%=aleatorio%>'></script>
