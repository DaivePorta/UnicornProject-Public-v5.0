<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CCLRHIS.ascx.vb" Inherits="vistas_CC_CCLRHIS" %>
<style>
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4>
                    <i class="icon-reorder"></i>REPORTE HISTÓRICO CLIENTE</h4>
                <div class="actions">
...
<script type="text/javascript" src="../vistas/CC/js/CCLRHIS.js"></script>
<script>
