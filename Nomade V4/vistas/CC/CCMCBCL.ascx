                ...
                <div class="row-fluid">
                    ...
                    <div class="span5">
                        ...
                        <div class="form-actions">
                            ...
                            <button style="display: none;" id="btnAnticipoCompensar" type="button" class="btn black Anticipocompensar"><i class="icon-plus"></i>Anticipo a Compensar</button>
                        </div>
                        <%--   </div>
                         </div>--%>
                    </div>
...
<div id="muestralistap_a" style="display: block; width: 850px; left: 45%;" class="modal hide fade" tabindex="-1" role="dialog" aria-hidden="true" aria-labelledby="myModalLabel">
    <div class="modal-header" style="padding: 1px 15px; background: #4b8df8; color: #ffffff;">
        ...
        <h4><i class="icon-reorder"></i>&nbsp;<span id="tituloModal_a">ANTICIPOS A COMPENSAR</span> </h4>
    </div>
    <div class="modal-body" aria-hidden="true">
        <div class="row-fluid">
            <div class="span12" id="divmodal_a">
                <!--aki se carga el contenido por jquery-->

                <table id="tblAnticiposCompensar" cellspacing="0" class="display DTTT_selectable" border="0">
                    <thead style="background-color: rgb(35, 119, 155); color: white;">
                        <tr align="center">
                            <th>DOCUMENTO</th>
                            <th>MONTO TOTAL</th>
    ...
    <div class="modal-footer">
        <div class="row-fluid" align="rigth">
            <small>Haga click en el anticipo que desea agregar.</small>
        </div>
