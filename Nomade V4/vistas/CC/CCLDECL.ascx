<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CCLDECL.ascx.vb" Inherits="vistas_CC_CCLDECL" %>
<style>
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>DEUDAS DE CLIENTES</h4>
                <div class="actions">
...
<script type="text/javascript" src="../vistas/CC/js/CCLDECL.js"></script>
<script>
