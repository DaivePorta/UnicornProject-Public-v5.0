<%@ WebHandler Language="VB" Class="CCLCOGE" %>

Imports System
Imports System.Web
Imports System.Data

Public Class CCLCOGE : Implements IHttpHandler
        ...
        Try
            ...
            Select Case OPCION
                ...
                Case "1" 'reporte de cuentas por cobrar
                    ...
                    dt = ccCuentaPorCobrar.ListarCuentasPorCobrarGeneral(p_CTLG_CODE, p_SCSL_CODE, Utilities.fechaLocal(p_HASTA))
                    res = GenerarTablaCuentaPorCobrarGeneral(dt)
    ...
    Public Function GenerarTablaCuentaPorCobrarGeneral(ByVal dt As DataTable) As String
