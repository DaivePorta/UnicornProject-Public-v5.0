<%@ WebHandler Language="VB" Class="CCLRCPC" %>

Imports System
Imports System.Web
Imports System.Data

Public Class CCLRCPC : Implements IHttpHandler
        ...
        Try
            ...
            Select Case OPCION
                ...
                Case "1" 'reporte de cuentas por cobrar
                    ...
                    dt = ccCuentaPorCobrar.ListarCuentasPorCobrar(p_CTLG_CODE)
    ...
    Public Function GenerarTablaCuentaPorCobrar(ByVal dt As DataTable) As String
        ...
        Else
            ...
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                resb.AppendFormat("<td align='left' >{0}</td>", dt.Rows(i)("TABLA").ToString())
                resb.AppendFormat("<td align='left' >{0}</td>", dt.Rows(i)("PIDM").ToString())
