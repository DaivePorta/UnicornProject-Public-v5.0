<%@ WebHandler Language="VB" Class="CCLRHIS" %>

Imports System
Imports System.Web
Imports System.Data

Public Class CCLRHIS : Implements IHttpHandler
        ...
        Try
            ...
            Select Case OPCION
                ...
                Case "1" 'reporte de cuentas por cobrar
                    ...
                    dt = ccCuentaPorCobrar.ListarCuentasPorCobrarPorClienteHistorico(p_CTLG_CODE, p_CLIE_PIDM, Utilities.fechaLocal(p_DESDE), Utilities.fechaLocal(p_HASTA), "")
    ...
    Public Function GenerarTablaCuentaPorCobrar(ByVal dt As DataTable) As String
        ...
        resb.AppendFormat("<th>FECHA <br/>EMISION</th>")
