<%@ WebHandler Language="VB" Class="CCLRACR" %>

Imports System
Imports System.Web
Imports System.Data

Public Class CCLRACR : Implements IHttpHandler
        ...
        Try
            Select Case OPCION
                Case "1" 'Generar tabla Creditos
                    ...
                    dt = ccLineaCredito.ListarReporteAnaliticoCreditoClientes(p_CTLG_CODE, p_ANIO, p_MES)
    ...
    Public Function GenerarTablaDatos(ByVal dt As DataTable) As String
        ...
        resb.AppendFormat("<th style='text-align:center;'>LÍNEAS CLIENTES ({0})</th>", simbMonedaBase)
        ...
        Else
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                resb.AppendFormat("<td style='text-align:center;'>{0}</td>", dt.Rows(i)("LINEA_CLIENTES").ToString())
