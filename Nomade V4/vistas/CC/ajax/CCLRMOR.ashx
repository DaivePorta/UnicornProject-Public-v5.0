<%@ WebHandler Language="VB" Class="CCLRMOR" %>

Imports System
Imports System.Web
Imports System.Data

Public Class CCLRMOR : Implements IHttpHandler
        ...
        Try
            ...
            Select Case OPCION
                ...
                Case "1" 'reporte de cuentas por pagar
                    ...
                    dt = ccCuentaPorCobrar.ListarClientesMorosos(p_CTLG_CODE)
                    res = GenerarTablaMorosos(dt)
    ...
    Public Function GenerarTablaMorosos(ByVal dt As DataTable) As String
        ...
        Next
        '------
        resb.AppendFormat("<table id=""tblMorosos"" class=""display DTTT_selectable"" border=""0"">")
        resb.AppendFormat("<thead>")
        resb.AppendFormat("<th>COD CLIENTE</th>")
        resb.AppendFormat("<th>CLIENTE</th>")
        resb.AppendFormat("<th>DIRECCIÓN</th>")
        resb.AppendFormat("<th>TELÉFONO</th>")
        resb.AppendFormat("<th>DÍAS</th>")
        ...
        Else
            ...
            For i As Integer = 0 To dt.Rows.Count - 1
                resb.AppendFormat("<tr>")
                resb.AppendFormat("<td align='left' >{0}</td>", dt.Rows(i)("COD_CLIENTE").ToString())
                resb.AppendFormat("<td align='left' >{0}</td>", dt.Rows(i)("RAZON_SOCIAL").ToString())
                resb.AppendFormat("<td align='left' >{0}</td>", dt.Rows(i)("DIRECCION").ToString())
