<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NALMOAL.ascx.vb" Inherits="vistas_NA_NALMOAL" %>
<style>
    @media print {
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>MOVIMIENTO DE PRODUCTOS EN ALMACÉN</h4>
                <div class="actions">
...
<script type="text/javascript" src="../vistas/NA/js/NALMOAL.js"></script>
<script>
