...
Partial Class vistas_NA_NALLRIV
    Inherits Nomade.N.Cub
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Dim filep As String
        Dim filen, ruta As String
        filep = "Archivos\"
        filen = "LE" + hddRuc.Value + hddAnio.Value + hddMes.Value + "00130100" + "00" + "1" + "1" + "1" + "1" + ".pdf"
    ...
    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Dim filen, ruta As String
        filep = "Archivos\"
        filen = "LE" + hddRuc.Value + hddAnio.Value + hddMes.Value + "00130100" + "00" + "1" + "1" + "1" + "1" + ".txt"
        ruta = Server.MapPath("~") + filep + filen
        hddDesca.Value = ruta
