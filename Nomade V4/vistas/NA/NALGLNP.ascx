<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NALGLNP.ascx.vb" Inherits="vistas_NA_NALGLNP" %>
<div class="row-fluid">
    <div class="span12 ">
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4>
                    <i class="icon-reorder"></i>LISTA LINEA DE CREDITO PROVEEDORES</h4>
                <div class="actions">
                    ...
                    <table id="tblBandeja" class="display  DTTT_selectable" border="0" style="overflow-x: scroll;">
                        <thead>
                            <tr align="center">
                                ...
                                <th>TIPO DOC</th>
                                <th>DOC</th>
                                <th>RAZON SOCIAL / NOMBRE PROVEEDOR</th>
                                <th>MONTO</th>
                                <th>MONEDA</th>
                                <th>PLAZO (DIAS)</th>
                            </tr>
