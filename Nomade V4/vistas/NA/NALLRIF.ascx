<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NALLRIF.ascx.vb" Inherits="vistas_NA_NALLRIF" %>
<div class="row-fluid">

    <div class="span12">
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>REGISTRO DE INVENTARIO  PERMANENTE DE UNIDADES FISICAS </h4>
                <div class="actions">
            ...
            <div class="portlet-body">
                ...
                <div class="row-fluid" id="filtros_2">
                    ...
                    <div class="span2">
                        <div class="control-group">
                            <div class="controls">
                                <select id="hf10" class="span12" data-placeholder="Seleccione un Almacen!">
                                    <option></option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="row-fluid" id="filtros_3">
                    ...
                    <div class="span1">
                        <div class="control-group ">
                            <label>CODIGO DE LA EXISTENCIA</label>
                        </div>
                    </div>
                    <div class="span1">
                        <div class="control-group">
...
<script type="text/javascript" src="../vistas/NA/js/NALLRIF.js"></script>
