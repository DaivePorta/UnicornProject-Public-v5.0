<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NALRSPP.ascx.vb" Inherits="vistas_NA_NALRSPP" %>
<style>
    ...
    <div class="span12">
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>REPORTE DE STOCK DE PRODUCTOS POR PESO</h4>
                <div class="actions">
                    ...
                    <div class="span10">
                        <div id="divValorizadoTotal" style="display: none;">
                            <div class="span2 offset1">
                                <div class="control-group">
                                    <label class="control-label"><strong>TOTAL PESO (Kg):</strong></label>
                                </div>
                            </div>
                            <div class="span2">
                                <div class="control-group">
...
<script type="text/javascript" src="../vistas/NA/js/NALRSPP.js"></script>
