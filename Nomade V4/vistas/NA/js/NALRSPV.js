var NALRSPV = function () {
    ...
    var eventoControles = function () {
        ...
        $('#buscar').on('click', function () {
            ...
            if (vErrors(["cboEmpresas", "slsMoneda"])) {
    ...
    function listarProductos(empresa, almacen, grupos, moneda) {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "vistas/na/ajax/nalmerc.ashx?OPCION=5&p_almacen=" + almacen + "&p_grupo=" + grupos + "&p_ctlg=" + empresa + "&p_mone_code=" + moneda,
    ...
    var handleTable = function () {
        var parms = {
            ...
            columns: [              
                ...
                { data: "COSTO", type:"formatoMiles" },
                { data: "VALORIZADO",type:"formatoMiles" }             
            ],
            stateSave: false,
            footerCallback: function (row, data, start, end, display) {
                ...
                api.data().filter(function (obj) {
                    oArrayItemsSumar.push(obj.VALORIZADO);
                });
                ...
                if (oArrayItemsSumar.length > 0) {
                    ...
                    $("#lblValorizadoTotal").html(api.data()[0].SIMBOLO + formatoMiles(oArrayItemsSumar.reduce(
