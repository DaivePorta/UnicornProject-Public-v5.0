<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NALSPAL.ascx.vb" Inherits="vistas_NA_NALSPAL" %>
<style>
    ...
    <div class="span12">
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>REPORTE DE STOCK DE PRODUCTOS POR ALMACENES</h4>
                <div class="actions">
...
<div id="scr"></div>
<script type="text/javascript" src="../vistas/NA/js/NALSPAL.js"></script>
<script>
