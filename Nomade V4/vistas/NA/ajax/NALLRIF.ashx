<%@ WebHandler Language="VB" Class="NALLRIF" %>
...
Public Class NALLRIF : Implements IHttpHandler
   ...
   TIPO_ALMACENAJE, ESTADO, USUARIO, SISTEMA_ALMACENAJE, PALETIZADO_IND, NRO_PALETS As String
    ...
    Public Function exportar2() As String
        ...
        Dim cNomArch As String = "LE" + p_ruc + p_anio + p_mes + "00120100" + "00" + "1" + "1" + "1" + "1" + ".pdf"
    ...
    Public Function exportar() As String
        ...
        res = "Archivos\" + "LE" + p_ruc + p_anio + p_mes + "00120100" + "00" + "1" + "1" + "1" + "1" + ".txt"
    ...
    Public Function GenerarTablaPro(ByVal dt As DataTable) As String
        ...
        Dim sumaEntrada, salida As Decimal
        If Not dt Is Nothing Then
            ...
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                sumaEntrada = sumaEntrada + dt.Rows(i)("CA_ENT").ToString
                salida = salida + dt.Rows(i)("CA_SAL").ToString()
            Next
            res += "</tbody>"
            ...
            res += "<th align='center' >" & sumaEntrada.ToString("##,#0.00") & "</th>"
            res += "<th align='center'>" & salida.ToString("##,#0.00") & "</th>"
    ...
    Sub HTMLToPDF(ByVal HTML As StringBuilder, ByVal FilePath As String)
        ...
        document = New Document(PageSize.A4, 25, 25, 45, 20)
    ...
    Function getHtmlTextPDF() As StringBuilder
        ...
        htmlText.Append("                <td   align='center' valign='bottom'>  " & vbCrLf)
        htmlText.Append("                  <b>INVENTARIO PERMANENTE EN UNIDADES FÍSICAS</b> " & vbCrLf)
        htmlText.Append("                </td>  " & vbCrLf)
        htmlText.Append("            </tr>  " & vbCrLf)
        '/tr2
        ...
        htmlText.Append("            <tr  font color='white' bgcolor='black'>  " & vbCrLf)
        htmlText.Append("                <td width='52%' align='left valign='bottom'>  " & vbCrLf)
        htmlText.Append("                    <b>DOCUMENTO DE TRASLADO, COMPROBANTE DE PAGO,DOCUMENTO INTERNO O SIMILAR</b>  " & vbCrLf)
        htmlText.Append("                </td>  " & vbCrLf)
        htmlText.Append("                <td width='16%' align='center' valign='bottom'>  " & vbCrLf)
        htmlText.Append("                  <b>TIPO DEOPERACIÓN</b> " & vbCrLf)
        htmlText.Append("                </td>  " & vbCrLf)
        htmlText.Append("                <td width='10%' align='center' valign='bottom'>  " & vbCrLf)
        htmlText.Append("                  <b>ENTRADAS</b> " & vbCrLf)
        htmlText.Append("                </td>  " & vbCrLf)
        htmlText.Append("                <td width='10%' align='center' valign='bottom'>  " & vbCrLf)
        htmlText.Append("                  <b>SALIDAS</b> " & vbCrLf)
        htmlText.Append("                </td>  " & vbCrLf)
        htmlText.Append("                <td width='12%' align='center' valign='bottom'>  " & vbCrLf)
        ...
        htmlText.Append("<table width='100%'   border='1' font size=9pt>  " & vbCrLf)
        htmlText.Append("            <tr >  " & vbCrLf)
        htmlText.Append("                <td width='13%' align='left' valign='bottom' bgcolor='#666666' color='white'>  " & vbCrLf)
        ...
        htmlText.Append("                </td>  " & vbCrLf)
        htmlText.Append("                <td width='16%'>  " & vbCrLf)
        ...
        htmlText.Append("                  <b></b> " & vbCrLf)
        htmlText.Append("                </td>  " & vbCrLf)
        htmlText.Append("                <td width='12%'>  " & vbCrLf)
        htmlText.Append("                  <b></b> " & vbCrLf)
        htmlText.Append("                </td>  " & vbCrLf)
        htmlText.Append("            </tr>  " & vbCrLf)
        htmlText.Append(" </table>  " & vbCrLf)
        ...
        If Not dt Is Nothing Then
            ...
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                htmlText.Append("            <tr >  " & vbCrLf)
                htmlText.Append("                <td width='13%'  >  " & vbCrLf)
            ...
            htmlText.Append("                    <b></b>  " & vbCrLf)
            htmlText.Append("                </td>  " & vbCrLf)
            htmlText.Append("                <td border='1' width='16%'>  " & vbCrLf)
            htmlText.Append("                  <b>TOTALES</b> " & vbCrLf)
            htmlText.Append("                </td>  " & vbCrLf)
            htmlText.Append("                <td border='1' width='10%' >  " & vbCrLf)
            htmlText.Append("                  <b>" & sumaEntrada.ToString("##,#0.00") & "</b> " & vbCrLf)
            htmlText.Append("                </td>  " & vbCrLf)
            htmlText.Append("                <td border='1' width='10%' >  " & vbCrLf)
            htmlText.Append("                  <b>" & salida.ToString("##,#0.00") & "</b> " & vbCrLf)
            htmlText.Append("                </td>  " & vbCrLf)
            htmlText.Append("                <td border='1' width='12%'>  " & vbCrLf)
            htmlText.Append("                  <b></b> " & vbCrLf)
            htmlText.Append("                </td>  " & vbCrLf)
            htmlText.Append("            </tr>  " & vbCrLf)
            htmlText.Append(" </table>  " & vbCrLf)
