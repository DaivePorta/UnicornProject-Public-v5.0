<%@ WebHandler Language="VB" Class="NALRELO" %>

Imports System
Imports System.Web
Imports System.Data

Public Class NALRELO : Implements IHttpHandler

    Dim code As String
    Dim opcion As String
    Dim p_ALMACEN, p_GRUP_CODE, p_SCSL_CODE, p_UNME_DET, p_TIPO, p_mone_code, p_DATO_LOG As String
   ...
   TIPO_ALMACENAJE, ESTADO, USUARIO, SISTEMA_ALMACENAJE, PALETIZADO_IND, NRO_PALETS As String
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        p_DATO_LOG = context.Request("p_dato_log")
        ...
        Try
            ...
            Select Case opcion
                ...
                Case "5" 'TABLA REPORTE LOGISTICO
                    dtp = gPro.listar_productosLogistico(p_ALMACEN, p_GRUP_CODE, p_mone_code, p_DATO_LOG, p_ctlg)
                    If Not dtp Is Nothing Then
                        res = Utilities.Datatable2Json(dtp)
                    Else
                        res = "[]"
