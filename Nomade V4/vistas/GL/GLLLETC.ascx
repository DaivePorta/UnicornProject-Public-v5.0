<%@ Control Language="VB" AutoEventWireup="false" CodeFile="GLLLETC.ascx.vb" Inherits="vistas_GL_GLLLETC" %>
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4>
                    <i class="icon-reorder"></i>LISTA LETRAS POR COBRAR</h4>
                <div class="actions">
                    <a class="btn black printlist "><i class="icon-print"></i>Imprimir</a>
                    <a href="?f=glmletc" class="btn green"><i class="icon-plus"></i>Nuevo</a>
                    <a href="?f=gllletc" class="btn red"><i class="icon-list"></i>Listar</a>
                </div>
