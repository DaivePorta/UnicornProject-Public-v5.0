<%@ Control Language="VB" AutoEventWireup="false" CodeFile="GLMLETR.ascx.vb" Inherits="vistas_GL_GLMLETR" %>
    ...
    <div class="span12">
        ...
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>LETRAS POR PAGAR</h4>
                <div class="actions">
                     <a class="btn black" id="btnimprimir"><i class="icon-print"></i>&nbsp;Imprimir</a>
                    <a class="btn green" href="?f=glmletr"><i class="icon-plus"></i> Nuevo</a>
                    <a class="btn red" href="?f=gllletr"><i class="icon-list"></i> Listar</a>
              ...
              <div class="row-fluid" id="ctrlRadio" style="display:none;">
                ...
                <div class="row-fluid">
                   ...
                   <div class="span2">
                       <div class="control-group">
                            <div class="controls">
                                <input class="span12 obligatorio" type="text" id="txt_nro_letra" >
                             </div>
                        </div>
                   </div>
                   <div class="span1">
