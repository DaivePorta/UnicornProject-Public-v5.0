<%@ Control Language="VB" AutoEventWireup="false" CodeFile="GLMCANP.ascx.vb" Inherits="vistas_GL_GLMCANP" %>
    ...
    <div class="span12">
        ...
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>CANJE DE LETRAS Y FACTURAS POR PAGAR</h4>
                <div class="actions">
                     
                    <a class="btn green" href="?f=GLMCANP"><i class="icon-plus"></i> Nuevo</a>
                    <a class="btn red" href="?f=GLLCANP"><i class="icon-list"></i> Listar</a>
            ...
            <div class="portlet-body" id="div_letra">
                                ...
                                <div class="span2">
                                    <div class="control-group">
                                        <div class="controls" id="btnOrigen">
                                            <button type="button" id="btnBuscarDctoOrigen" class="fila_0 btn blue search" onclick="buscarDocumento2(this)"><i class="icon-search" style="line-height: initial;"></i></button>
                ...
                <div id="divSimuLetras" style="padding-top: 10px; border-top: solid #e5e5e5 2px;">                                    
                  ...
                  <div class="form-actions" id="divControles">
                    <button type="button" id="grabar" class="btn blue" onclick="CrearCanjePagar();"><i class="icon-save"></i> Canjear</button>
