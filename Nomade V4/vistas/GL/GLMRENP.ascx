<%@ Control Language="VB" AutoEventWireup="false" CodeFile="GLMRENP.ascx.vb" Inherits="vistas_GL_GLMRENO" %>
    ...
    <div class="span12">
        ...
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>RENOVACION DE LETRAS POR PAGAR</h4>
                <div class="actions">

                    <a class="btn green" href="?f=glmrenp"><i class="icon-plus"></i>Nuevo</a>
                    <a class="btn red" href="?f=gllrenp"><i class="icon-list"></i>Listar</a>
                ...
                <div id="divSimuLetras" style="display: none; padding-top: 30px; border-top: solid #e5e5e5 2px;">
                    ...
                    <div class="row-fluid" id="divPrmtsSimulacion">
                        ...
                        <div class="span1">
                            <div class="control-group">
                                <div class="controls">
                                    <input type="number" class="span12" id="txtNroLetras" />
                                </div>
                            </div>
                        </div>
                        <div class="span1">
