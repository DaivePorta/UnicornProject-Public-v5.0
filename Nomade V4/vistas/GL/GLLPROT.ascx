<%@ Control Language="VB" AutoEventWireup="false" CodeFile="GLLPROT.ascx.vb" Inherits="vistas_GL_GLLPROT" %>
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4>
                    <i class="icon-reorder"></i>LISTA LETRAS PROTESTADAS POR COBRAR</h4>
                <div class="actions">
