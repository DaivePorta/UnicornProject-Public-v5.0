<%@ Control Language="VB" AutoEventWireup="false" CodeFile="MPMGNLO.ascx.vb" Inherits="vistas_MP_MPMGNLO" %>
<div class="row-fluid">
    <div class="span12">
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>&nbsp;GENERACION DE LOTE</h4>
                <div class="actions">
...
<script type="text/javascript" src="../vistas/MP/js/MPMGNLO.js"></script>
<script>
