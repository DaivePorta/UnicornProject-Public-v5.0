<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CTLMAAC.ascx.vb" Inherits="vistas_CT_CTLMAAC" %>
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>MAYORIZACIÓN DE ASIENTOS CONTABLES</h4>
                <div class="actions">
...
<script type="text/javascript" src="../vistas/CT/js/CTLMAAC.js"></script>
<script>
