<%@ WebHandler Language="VB" Class="CTLMAAC" %>

Imports System
Imports System.Web
Imports System.Data

Public Class CTLMAAC : Implements IHttpHandler
        ...
        Try
            Select Case OPCION
                Case "1" 'Obtiene Docunento
                    ...
                    dt = nvVenta.MayorizacionAsientosCont(CTLG_CODE, SCSL_CODE, Utilities.fechaLocal(DESDE), Utilities.fechaLocal(HASTA))
