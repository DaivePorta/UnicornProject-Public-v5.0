<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NCMRFIR.ascx.vb" Inherits="vistas_NC_NCMRFIR" %>
<div class="row-fluid">
    <div class="span12">
        <!-- INICIA CUADRO PARA LA FORMA -->
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>REGISTRAR FIRMA</h4>
                <div class="actions">
            ...
            <div class="portlet-body">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span5">
                        <div class="control-group ">
                            <div class="controls">
                                <input id="txtpersona" placeholder="Ingrese Apellidos y Nombres" class="span9 personas"    type="text" autocomplete="off" />
