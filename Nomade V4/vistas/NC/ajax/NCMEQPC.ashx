<%@ WebHandler Language="VB" Class="NCMEQPC" %>

Imports System
Imports System.Web
Imports System.Data

Public Class NCMEQPC : Implements IHttpHandler
  
    Dim OPCION As String
    
    Dim CODE, CTLG_CODE, CODE_BASE, CECC_CODE_BASE, CECD_CODE_BASE, CECC_CODE_EQUIVALENTE, CECD_CODE_EQUIVALENTE, ESTADO_IND, FECHA_INICIO, FECHA_FIN, USUA_ID As String
    ...
    Dim r As New Nomade.NC.NCPlanCuentas("Bn")
    Dim s As New Nomade.NC.NCNivelPlanContable("Bn")
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        CODE_BASE = context.Request("CODE_BASE")
        ...
        Try
            ...
            Select Case OPCION
                Case "0"
                    ...
                    dt = p.Listar_Equivalencia_PlanCuentas(String.Empty, String.Empty, String.Empty, String.Empty)
                    res = GenerarHtmlEquivalenciaPlanCuentas(dt)
                Case "1"
                ...
                Case "2"
                    context.Response.ContentType = "application/json; charset=utf-8"
                    dt = s.Listar_NivelPlanContable(String.Empty, CTLG_CODE, String.Empty, String.Empty, String.Empty, String.Empty)
                    If Not (dt Is Nothing) Then
                        resb.Append("[")
                        For Each MiDataRow As DataRow In dt.Rows
                            resb.Append("{")
                ...
                Case "3"
                    context.Response.ContentType = "application/json; charset=utf-8"
                    dt = r.Listar_PlanCuentas(String.Empty, String.Empty, String.Empty, CECC_CODE, String.Empty, String.Empty, USUA_ID)
                    If Not (dt Is Nothing) Then
                        resb.Append("[")
                        For Each MiDataRow As DataRow In dt.Rows
                            resb.Append("{")
                              resb.Append("""CODE"" :" & """" & MiDataRow("CODE").ToString & """,")
                            resb.Append("""DESCC"" :" & """" & MiDataRow("DESCR").ToString & """")
                            resb.Append("}")
                            resb.Append(",")
                        Next
                        resb.Append("{}")
                ...
                Case "N"
                    ...
                    End If
                    resArray = GrabarEquivalenciaPlanCuentas(CTLG_CODE, CECC_CODE_BASE, CECD_CODE_BASE, CECC_CODE_EQUIVALENTE, CECD_CODE_EQUIVALENTE, _
                ...
                Case "4"
                    context.Response.ContentType = "application/json; charset=utf-8"
                    dt = p.Listar_Equivalencia_PlanCuentas(CODE, String.Empty, String.Empty, String.Empty)
                    If Not (dt Is Nothing) Then
                        resb.Append("[")
                        For Each MiDataRow As DataRow In dt.Rows
                            resb.Append("{")
                            ...
                            resb.Append("""NOMBRE_PLAN_EQUIVALENTE"" :" & """" & MiDataRow("NOMBRE_EQUIVALENTE").ToString & """,")
                ...
                Case "M"
                    ...
                    If FECHA_FIN <> String.Empty Then
                        FECHA_FIN = Utilities.fechaLocal(FECHA_FIN)
                    End If
                    resArray = ActualizarEquivalenciaPlanCuentas(CODE, CTLG_CODE, CECC_CODE_BASE, CECD_CODE_BASE, CECC_CODE_EQUIVALENTE, CECD_CODE_EQUIVALENTE, _
                                                     ESTADO_IND, Utilities.fechaLocal(FECHA_INICIO), FECHA_FIN, USUA_ID)
                    resb.Append("[")
                    resb.Append("{")
                    resb.Append("""CODIGO"" :" & """" & resArray(0).ToString & """,")
    ...
    Public Function GenerarHtmlEquivalenciaPlanCuentas(ByVal dt As DataTable) As String
        If Not dt Is Nothing Then
            res = "<table id=""tblEquivalenciaPlanCuentas"" cellspacing=""0""  class=""display DTTT_selectable"">"
            res += "<thead>"
            res += "<tr>"
    ...
    Public Function GrabarEquivalenciaPlanCuentas(ByVal p_PTVEQPC_CTLG_CODE As String, ByVal p_PTVEQPC_CECC_CODE_BASE As String, ByVal p_PTVEQPC_CECD_CODE_BASE As String, _
        ...
        datos = p.Crear_Equivalencia_PlanCuentas(p_PTVEQPC_CTLG_CODE, p_PTVEQPC_CECC_CODE_BASE, p_PTVEQPC_CECD_CODE_BASE, _
                                                     p_PTVEQPC_CECC_CODE_EQUIVALENTE, p_PTVEQPC_CECD_CODE_EQUIVALENTE, _
                                                     p_PTVEQPC_ESTADO_IND, p_PTVEQPC_FECHA_INICIO, p_PTVEQPC_FECHA_FIN, _
                                                     p_PTVEQPC_USUA_ID)
        Return datos
    End Function
    
    Public Function ActualizarEquivalenciaPlanCuentas(ByVal p_PTVEQPC_CODE As String, ByVal p_PTVEQPC_CTLG_CODE As String, ByVal p_PTVEQPC_CECC_CODE_BASE As String, ByVal p_PTVEQPC_CECD_CODE_BASE As String, _
                                                    ByVal p_PTVEQPC_CECC_CODE_EQUIVALENTE As String, ByVal p_PTVEQPC_CECD_CODE_EQUIVALENTE As String, _
                                                    ByVal p_PTVEQPC_ESTADO_IND As String, ByVal p_PTVEQPC_FECHA_INICIO As String, ByVal p_PTVEQPC_FECHA_FIN As String, _
                                                    ByVal p_PTVEQPC_USUA_ID As String) As Array
        Dim datos(2) As String
        datos = p.Actualizar_Equivalencia_PlanCuentas(p_PTVEQPC_CODE, p_PTVEQPC_CTLG_CODE, p_PTVEQPC_CECC_CODE_BASE, p_PTVEQPC_CECD_CODE_BASE, _
                                                     p_PTVEQPC_CECC_CODE_EQUIVALENTE, p_PTVEQPC_CECD_CODE_EQUIVALENTE, _
                                                     p_PTVEQPC_ESTADO_IND, p_PTVEQPC_FECHA_INICIO, p_PTVEQPC_FECHA_FIN, _
                                                     p_PTVEQPC_USUA_ID)
        Return datos
