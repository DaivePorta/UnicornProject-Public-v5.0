<%@ WebHandler Language="VB" Class="NCTIAP" %>

Imports System
Imports System.Web
Imports System.Data

Public Class NCTIAP : Implements IHttpHandler
    

    Dim flag As String
    
    Dim dt As DataTable
    Dim p As New NOMADE.NC.NCTipoAP("Bn")
    Dim res As String
        ...
        Try
            ...
            Select Case flag.ToString
                ...
                Case "1"
                    ...
                    res = CrearTipoAP(codigosunat, descripcion, abreviatura, activo, user)
                    
                Case "2"
                    
                    res = ActualizarTipoAP(codigo, codigosunat, descripcion, abreviatura, activo, user)
                    
                Case "3"
                          
                    res = CambiarEstadoTipoAP(codigo)
                    
                Case Else
                          
                    context.Response.ContentType = "application/json; charset=utf-8"
                    dt = p.ListarTipoAP(codrec, String.Empty)
                    resb.Append("[")
                    resb.Append("{")
    ...
    Public Function CrearTipoAP(ByVal p_codigosunat As String, _
                                       ByVal p_descripcion As String, ByVal p_abreviatura As String, ByVal p_activo As String, _
                                       ByVal p_user As String) As String
        Dim datos As String
        
        datos = p.CrearTipoAP(p_codigosunat, p_descripcion, p_abreviatura, p_activo, p_user)
    ...
    Public Function CambiarEstadoTipoAP(ByVal p_codigo As String) As String
        ...
        datos = p.CambiarEstadoTipoAP(p_codigo)
    ...
    End Function
     ...
     Public Function ActualizarTipoAP(ByVal p_codigo As String, ByVal p_codigosunat As String, _
                                       ByVal p_descripcion As String, ByVal p_abreviatura As String, ByVal p_activo As String, _
                                       ByVal p_user As String) As String
        Dim datos As String
        
        datos = p.ActualizarTipoAP(p_codigo, p_codigosunat, p_descripcion, p_abreviatura, p_activo, p_user)
