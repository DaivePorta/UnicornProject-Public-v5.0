<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NCMNOOL.ascx.vb" Inherits="vistas_NC_NCMNOOL" %>
<div class="row-fluid">
    <div class="span12 ">
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>&nbsp;NOMENCLATURA ORDENES DE LOTE</h4>
...
<script type="text/javascript" src="../vistas/NC/js/NCMNOOL.js"></script>
<script>
