<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NCMTITV.ascx.vb" Inherits="vistas_NC_NCMTITV" %>
    ...
    <div class="span12">
        ...
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>TIPO DE TITULOS Y VALORES</h4>
                <div class="actions">
                    <a class="btn green" href="?f=ncmtitv"><i class="icon-plus"></i> Nuevo</a>
                    <a class="btn red" href="?f=ncltitv"><i class="icon-list"></i> Listar</a>
                </div>
