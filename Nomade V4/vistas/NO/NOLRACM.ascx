<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NOLRACM.ascx.vb" Inherits="vistas_NO_NOLRACM" %>
    ...
    <div class="span12 ">
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>REPORTE DE ANALÍTICO DE COMPRAS MENSUALES</h4>
                <div class="actions">
...
<script type="text/javascript" src="../vistas/NO/js/NOLRACM.js"></script>
<script>
