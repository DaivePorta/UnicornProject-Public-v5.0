<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NOLAUCO.ascx.vb" Inherits="vistas_NO_NOLAUCO" %>
    ...
    <div class="span12">
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                ...
                <div class="actions">                    
                    <a class="btn green" href="?f=NOMAUCO"><i class="icon-plus"></i>Nuevo</a>
                    <a class="btn red" href="?f=NOLAUCO"><i class="icon-list"></i>Listar</a>
...
<script type="text/javascript" src="../vistas/NO/js/NOLAUCO.js"></script>
