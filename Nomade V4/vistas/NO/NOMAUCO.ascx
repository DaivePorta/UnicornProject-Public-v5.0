<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NOMAUCO.ascx.vb" Inherits="vistas_NO_NOMAUCO" %>
...
<script type="text/javascript" src="../vistas/NO/js/NOMAUCO.js"></script>
