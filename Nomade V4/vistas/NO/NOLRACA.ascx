<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NOLRACA.ascx.vb" Inherits="vistas_NO_NOLRACA" %>
    ...
    <div class="span12 ">
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>REPORTE DE ANALÍTICO DE COMPRAS ANUALES</h4>
                <div class="actions">
            ...
            <div class="portlet-body">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span2">
                        <div class="control-group">
                            <label class="control-label span12" style="text-align: right" for="txtAnio">AÑOS:</label>
                        </div>
                    </div>
                    <div class="span2">
                        <div class="control-group">
                            <div class="controls">
                                <select class="span12" id="cboAnios" multiple></select>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript" src="../vistas/NO/js/NOLRACA.js"></script>
<script>
