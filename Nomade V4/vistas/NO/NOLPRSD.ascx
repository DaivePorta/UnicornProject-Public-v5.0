<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NOLPRSD.ascx.vb" Inherits="vistas_NO_NOLPRSD" %>
<div class="row-fluid">
    <div class="span12">
            ...
            <div id="div" class="portlet-body">
                ...
                <div id="Div5" class="row-fluid">
                 <div class="span1">
                    ...
                    <div class="span11">
                         <div class="controls">
                            <%--<input id="txtGlosa" class="span12" type="text" data-provide="typeahead" />--%>
