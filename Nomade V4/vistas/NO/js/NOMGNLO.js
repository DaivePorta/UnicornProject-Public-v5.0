...
var NOMGNLO = function () {
    ...
    var autocompletarEmpleado = function (v_ID, v_value) {
        ...
        $.ajax({
            type: "post",
            //url: "vistas/NC/estereotipos/ajax/Empleado.ashx?OPCION=CONT&PIDM=" + 0 + "&CTLG_CODE=" + $('#cboEmpresas').val() + "&SCSL_CODE=" + $('#cboEstablecimiento').val() + "&ESTADO_IND=" + "",
                    ...
                    selectRazonSocial.typeahead({
                        ...
                        source: function (query, process) {
                            ...
                            for (var i = 0; i < datos.length; i++) {
                                ...
                                obj += '{';
                                obj += '"PIDM":"' + datos[i].PIDM + '","NOMBRE_EMPLEADO":"' + datos[i].NOMBRE_EMPLEADO + '"';
                                obj += '},';
                            }
                            obj += "{}";
                            obj = obj.replace(",{}", "");
