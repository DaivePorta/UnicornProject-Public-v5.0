<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NOLRAPC.ascx.vb" Inherits="vistas_NO_NOLRAPC" %>
    ...
    <div class="span12 ">
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>REPORTE ANALITICO DE PRODUCTOS COMPRADOS</h4>
                <div class="actions">
...
<script type="text/javascript" src="../vistas/NO/js/NOLRAPC.js"></script>
<script>
