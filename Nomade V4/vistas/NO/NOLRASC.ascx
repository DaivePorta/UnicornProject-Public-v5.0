<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NOLRASC.ascx.vb" Inherits="vistas_NO_NOLRASC" %>
    ...
    <div class="span12 ">
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>REPORTE ANALITICO DE SUBGRUPOS COMPRADOS</h4>
                <div class="actions">
...
<script type="text/javascript" src="../vistas/NO/js/NOLRASC.js"></script>
<script>
