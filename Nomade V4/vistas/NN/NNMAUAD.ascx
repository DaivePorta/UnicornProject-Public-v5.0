<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NNMAUAD.ascx.vb" Inherits="vistas_NN_NNMAUAD" %>
            ...
            <div class="portlet-body">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span4">
                        <div class="control-group">
                            <div class="controls">
                                <select id="cboEmpleado" class="span12" data-placeholder="Seleccione Empleado" disabled="disabled">
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row-fluid">
                    <div class="form-actions">                      
                         ...
                         <a class="btn" href="?f=NNMAUAD"><i class="icon-remove"></i>&nbsp;Cancelar</a>
                    </div>
                </div>
