<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NNLLIMA.ascx.vb" Inherits="vistas_NN_NNLLIMA" %>
<style type="text/css">
    ...
    <div class="span12">
        ...
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>LISTADO MARCACIONES DEL BIOMETRICO</h4>
                <div class="actions">
                    ...
                    <table id="tbl_marcaciones" class="display" style="height: 54px; font-family: serif;">
                        <thead style="background-color: rgb(52, 112, 160); color: aliceblue;">
                            <tr>
                                ...
                                <th style="width: 20%;">HORA INICIO
                                </th>
                                <th style="width: 20%;">HORA FIN
                                </th>
                            </tr>
                        </thead>
                    </table>
...
<script type="text/javascript" src="../vistas/NN/js/NNLLIMA.js"></script>
