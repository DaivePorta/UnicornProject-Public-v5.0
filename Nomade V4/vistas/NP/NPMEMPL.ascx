<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NPMEMPL.ascx.vb" Inherits="vistas_NP_NPMEMPL" %>
    ...
    <div class="span12">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>EMPLEADO</h4>
                <div class="actions">
                    <a class="btn green" href="?f=NPMEMPL"><i class="icon-plus"></i>&nbsp;Nuevo</a>
                    <a class="btn red" href="?f=NPLEMPL"><i class="icon-list"></i>&nbsp;Listar</a>
                </div>
