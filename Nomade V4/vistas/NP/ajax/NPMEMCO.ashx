...
Public Class NPMEMCO : Implements IHttpHandler
    ...
    Public Function GenerarTablaContratos(ByVal dt As DataTable) As String
        ...
        resb.AppendFormat("<th>CONTRATO</th>")
        resb.AppendFormat("<th style='display:none'>CTLG_CODE</th>")
        resb.AppendFormat("</thead>")
        ...
        If (dt Is Nothing) Then
            ...
            resb.AppendFormat("<td style='text-align:center;'> </td>")
            resb.AppendFormat("<td style='text-align:center;'> </td>")
            resb.AppendFormat("<td style='text-align:center'; style='display:none';> </td>")
            resb.AppendFormat("</tr>")
        Else
            ...
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                resb.AppendFormat("<td align='center'; style='display:none'; >{0}</td>", dt.Rows(i)("CTLG_CODE").ToString())
