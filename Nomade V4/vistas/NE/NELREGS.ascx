<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NELREGS.ascx.vb" Inherits="vistas_NE_NELREGS" %>
    ...
    <div class="span12 ">
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>REPORTE DE EGRESOS DETALLADO POR SUBCONCEPTOS</h4>
                <div class="actions">
            ...
            <div class="portlet-body">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span2">
                        <div class="control-group">
                            <label class="control-label span12" style="" for="cboGrupos">CONCEPTOS:</label>
                        </div>
                    </div>
                    <div class="span4">
                        <div class="control-group">
                    ...
                    <div class="span5">
                        ...
                        <table id="tblReporte" class="hidden" style="margin-left: 10px">
                            <thead>
                                <tr>
                                    <th style="text-align: center">N°</th>
                                    <th style="text-align: center">SubConcepto</th>
                                    <th style="text-align: center">Monto</th>
                                </tr>
                            </thead>
                            <tbody></tbody>
...
<script type="text/javascript" src="../vistas/NE/js/NELREGS.js"></script>
<script>
