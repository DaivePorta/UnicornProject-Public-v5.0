<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NFMPROP.ascx.vb" Inherits="vistas_NF_NFMPROP" %>
...
<!-- VENTANA MODAL QUE SE ACTIVA SI EL PROPIETARIO NO EXISTE-->
<div id="PerNoExiste" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" style="width: 30%; left: 60%!important;"
    ...
    <div class="modal-header">
        ...
        <h3 id="myModalLabel">Usuario no registrado</h3>
    </div>
    ...
    <div class="span12">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>PROPIETARIO</h4>
                <div class="actions">
                    <a class="btn green" href="?f=NFMPROP"><i class="icon-plus"></i>&nbsp;Nuevo</a>
                    <a class="btn red" href="?f=NFLPROP"><i class="icon-list"></i>&nbsp;Listar</a>
                </div>
            </div>
            <!-- FN DEL TITULO-->
            <!-- INICIA EL CUERPO DE LA FORMA-->
