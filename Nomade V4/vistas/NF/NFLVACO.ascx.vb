...
Partial Class vistas_NF_NFLVACO
    ...
    Dim p_PIDM As String = ""
    Dim p_NOMBRE_ARCHIVO As String = ""
    ...
    Protected Sub btnTxt_Click(sender As Object, e As EventArgs) Handles btnLibroTXT.Click
        ...
        p_NOMBRE_ARCHIVO = Me.hddNombreArchivo.Value

        filep = "Archivos\"

        filen = p_NOMBRE_ARCHIVO
    ...
    'Protected Sub btnTxt2_Click(sender As Object, e As EventArgs) Handles btnLibroTXT2.Click
    '    Dim dt As New System.Data.DataTable
    '    p_CTLG_CODE = Me.hddCtlg.Value
    '    p_SCSL_CODE = Me.hddScsl.Value
    '    p_DESDE = Me.hddDesde.Value
    '    p_HASTA = Me.hddHasta.Value
    '    p_PIDM = Me.hddPIDM.Value
