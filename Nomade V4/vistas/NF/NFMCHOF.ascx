<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NFMCHOF.ascx.vb" Inherits="vistas_NF_NFMCHOF" %>
...
<!-- VENTANA MODAL QUE SE ACTIVA SI EL CHOFER  NO EXISTE-->
    ...
    <div class="span12">
        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>CHOFER</h4>
                <div class="actions">
                    <a class="btn green" href="?f=NFMCHOF"><i class="icon-plus"></i>&nbsp;Nuevo</a>
                    <a class="btn red" href="?f=NFLCHOF"><i class="icon-list"></i>&nbsp;Listar</a>
                </div>
            </div>
            <!-- FN DEL TITULO-->
            <!-- INICIA EL CUERPO DE LA FORMA-->
