<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CAMNODP.ascx.vb" Inherits="vistas_CA_CAMNODP" %>
    ...
    <div class="span12">
        ...
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a href="?f=CAMNODP" class="btn green"><i class="icon-plus"></i>&nbsp;Nuevo</a>
                    <a href="?f=CALNODP" class="btn red"><i class="icon-list"></i>&nbsp;Listar</a>
                </div>
            ...
            <div class="portlet-body">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span1">
                        <div class="control-group">
                            <div class="controls">
                                <input id="txtSerieND" onkeypress='return ValidaNumeros(event,this);' maxlength="5" class="span12" type="text" placeholder="Serie" title="Serie Nota de Débito" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="span2">
                        <div class="control-group">
                            <div class="controls">
                                <input id="txtNroND" onkeypress='return ValidaNumeros(event,this);' maxlength="9" class="span12" type="text" placeholder="Nro" title="Número Nota de Débito" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="divAgregarDetalles">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span2">
                            <div class="control-group">
                                <div class="controls">
                                    <input type="text" id="txtCantidad" class="span12 right" placeholder="Cantidad" onkeypress="return ValidaDecimales(event,this,3)" value="1"/>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span1">
                            <div class="control-group">
                                <label class="control-label" for="txtPrecioUnitario">Precio</label>
                            </div>
                        </div>
                        <div class="span2">
                            <div class="control-group">
                        ...
                        <div class="span2">
                            <div class="control-group">
                                <label class="control-label" for="txtSubtotalItem">Valor</label>
                            </div>
                        </div>
                        <div class="span2">
                            <div class="control-group">
...
<script type="text/javascript" src="../vistas/CA/js/CAMNODP.js"></script>
<script>
