<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CAMANPR.ascx.vb" Inherits="vistas_CA_CAMANPR" %>
<div class="row-fluid" id="contenedor">
    <div class="span12">
        <!-- INICIA CUADRO PARA LA FORMA -->
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>ANULACIÓN NOTA DE CRÉDITO PROVEEDOR</h4>
                <div class="actions">
                    <a href="?f=CALANPR" class="btn red"><i class="icon-list"></i>&nbsp;Listar</a>
                </div>
            ...
            <div class="portlet-body">
                    ...
                    <div class="span4">
                        <div class="control-group">
                            <div class="controls" id="inputRazsocial">
                                <input id="txtrazsocial" class="span12" type="text" data-provide="typeahead" placeholder="Proveedor" disabled="disabled" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="span10 offset1">
                        <div class="row-fluid">
                            <div class="span12 alert alert-info">
                                <p id="P2">* Se removerán las amortizaciones, con esta nota de crédito, a otras compras.</p>
                                <p id="P3">* Se actualizará kardex e inventario para los productos en la nota de crédito.</p>
                                <p id="P1">* Los productos seriados se marcarán como no vendidos disponibles para vender.</p>                              
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row-fluid" id="divMensajes2" style="display:none;">
                    ...
                    <div class="span10 offset1">
                        <div class="row-fluid">
                            <div class="span12 alert alert-info">
                                <p id="P4">* Se removerán las amortizaciones que coincidan con el monto total de esta esta nota de crédito, a otras compras.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" src="../vistas/CA/js/CAMANPR.js"></script>
<script>
