<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CALNOPR.ascx.vb" Inherits="vistas_CA_CALNOPR" %>
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4>
                    <i class="icon-reorder"></i>LISTA NOTA DE CRÉDITO DEVOLUCIÓN PROVEEDOR</h4>
                <div class="actions">
