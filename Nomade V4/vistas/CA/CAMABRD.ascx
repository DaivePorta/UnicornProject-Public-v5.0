<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CAMABRD.ascx.vb" Inherits="vistas_CA_CAMABRD" %>
<div class="row-fluid">
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4>
                    <i class="icon-reorder"></i>ABRIR CAJA DIRECTA</h4>
                <div class="actions">
...
<script type="text/javascript" src="../vistas/CA/js/CAMABRD.js"></script>
