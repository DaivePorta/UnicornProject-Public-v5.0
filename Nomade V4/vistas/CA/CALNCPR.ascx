<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CALNCPR.ascx.vb" Inherits="vistas_CA_CALNCPR" %>
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4>
                    <i class="icon-reorder"></i>LISTADO NOTA DE CRÉDITO PROVEEDOR</h4>
                <div class="actions">
