<%@ Control Language="VB" AutoEventWireup="false" CodeFile="CALANCL.ascx.vb" Inherits="vistas_CA_CALANCL" %>
    ...
    <div class="span12 ">
        ...
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4>
                    <i class="icon-reorder"></i>LISTA ANULACIÓN NOTA DE CRÉDITO CLIENTE</h4>
                <div class="actions">
...
<script type="text/javascript" src="../vistas/CA/js/CALANCL.js"></script>
