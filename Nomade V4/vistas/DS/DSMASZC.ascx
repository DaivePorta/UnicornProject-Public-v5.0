<%@ Control Language="VB" AutoEventWireup="false" CodeFile="DSMASZC.ascx.vb" Inherits="vistas_DS_DSMASZC" %>
    ...
    <div class="span12">
        ...
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>ASIGNAR ZONAS DISTRIBUCIÓN</h4>
                <div class="actions">
            ...
            <div class="portlet-body">
                ...
                <div class="form-actions">
                    <a id="grabar" class="btn blue"><i class=" icon-save"></i>&nbsp;Asignar</a>
