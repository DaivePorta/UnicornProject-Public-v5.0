var COLREVE = function () {
    ...
    function listarRegistroVentas() {
        ...
        var jqxhr = $.ajax({
            type: "POST",
            url: "vistas/CO/ajax/colreve.ASHX",
            contentType: false,
            data: data,
            async: true,
            processData: false,
            beforeSend: function () { Bloquear($("#ventana"), "Generando libro de ventas ...") },
            cache: false
        })
       .success(function (datos) {
           Desbloquear("ventana");
    ...
    function fnGenerarPDF() {
        ...
        $.ajax({
            type: "POST",
            url: "vistas/co/ajax/colreve.ashx?OPCION=5",
            contentType: false,
            data: data,
            processData: false,
            cache: false,
    ...
    //    $.ajax({
    //        type: "POST",
    //        url: "vistas/co/ajax/colreve.ashx?OPCION=6",
    //        contentType: false,
    //        data: data,
    //        processData: false,
    //        cache: false,
...
var NuevaPantalla = function () {
    window.location.href = '?f=COLREVE';
}
