<%@ Control Language="VB" AutoEventWireup="false" CodeFile="COLRECN.ascx.vb" Inherits="vistas_CO_COLRECN" %>
<style>
    #tblRegistroCompras {
        max-width: 3000px;
        width: 2570px;
    ...
    <div class="span12">
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>LIBRO 8.2. REGISTRO DE COMPRAS NO DOMICILIADOS</h4>
                <div class="actions">
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    <select id="cboTipo" class="span12" data-placeholder="REGISTRO" disabled="disabled">
                                        <option value="080200" selected="selected">Registro de Compras No Domiciliados</option>
                                        <%--<option value="08000">Registro de Compras - Información de operaciones con sujetos no domiciliados</option>--%>
...
<script type="text/javascript" src="../vistas/CO/js/COLRECN.js"></script>
