<%@ Control Language="VB" AutoEventWireup="false" CodeFile="COLRVIE.ascx.vb" Inherits="vistas_CO_COLRVIE" %>
    ...
    <div class="span12">
        <div class="portlet box blue" id="ventana">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>SIRE SUNAT: REGISTRO DE VENTAS (RVIE)</h4>
                <div class="actions">
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    <select id="cboTipo" class="span12" data-placeholder="REGISTRO" disabled="disabled">
                                        <option value="140100" selected="selected">Registro de Ventas e Ingresos</option>
...
<script type="text/javascript" src="../vistas/CO/js/COLRVIE.js"></script>
