<%@ Control Language="VB" AutoEventWireup="false" CodeFile="COLIBDI.ascx.vb" Inherits="vistas_CO_COLIBDI" %>
<style>
    #tblLibroDiario {
        max-width: 3000px;
        width: 2570px;
        ...
        #tblLibroDiario thead tr {
            font-size: 0.9em !important;
            color: white;
        }

        #tblLibroDiario thead th {
            text-align: center;
        ...
        #tblLibroDiario thead {
            background-color: #cbcbcb;
        }

        #tblLibroDiario tbody td {
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    <select id="cboTipo" class="span12" data-placeholder="REGISTRO" disabled="disabled">
                                        <option value="050100" selected="selected">Libro Diario</option>
                                    </select>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript" src="../vistas/CO/js/COLIBDI.js"></script>
