<%@ Control Language="VB" AutoEventWireup="false" CodeFile="COLREVE.ascx.vb" Inherits="vistas_CO_COLREVE" %>
<style>
    #tblRegistroVentas {
        max-width: 3000px;
        width: 2570px;
...
<script type="text/javascript" src="../vistas/CO/js/COLREVE.js"></script>
