<%@ WebHandler Language="VB" Class="COLRECO" %>
...
Public Class COLRECO : Implements IHttpHandler
    ...
    Public Function GenerarTXT(ByVal dt As System.Data.DataTable) As String
        ...
        Try
            If Not dt Is Nothing Then
                res = "Archivos\" + "LE" + p_RUC + p_ANIO + p_MES + "00080100" + "00" + "1" + "1" + "1" + "1" + ".txt"
            Else
                res = "Archivos\" + "LE" + p_RUC + p_ANIO + p_MES + "00080100" + "00" + "1" + "0" + "1" + "1" + ".txt"
            End If
            ...
            If Not dt Is Nothing Then
                ...
                For i As Integer = 0 To dt.Rows.Count - 1
                    ...
                    ElseIf (dt.Rows(i)("OPERACION").ToString() = "DSTGRA" Or dt.Rows(i)("OPERACION").ToString() = "DGRAES") Then
                        ...
                        'cadena += " | | | | | |"
                        cadena += " | | | | |" 'ENTRE EL SEPTIMO Y OCTAVO ESPACIO SE AGREGA ISC Y IMPUESTO A LAS BOLSAS DE PLASTICO
    ...
    Public Function GenerarTablaRegistroCompras(ByVal dt As System.Data.DataTable) As StringBuilder
        ...
        If Not dt Is Nothing Then
            ...
            resb.AppendFormat("<td colspan='1' align='center' >{0}</td>", String.Format("{0:#0.00}", "0.00")) 'Impuesto al consumo de bolsas de plastico
