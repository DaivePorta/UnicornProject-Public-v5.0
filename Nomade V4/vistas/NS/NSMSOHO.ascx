<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NSMSOHO.ascx.vb" Inherits="vistas_NS_NSMSOHO" %>
    ...
    <div class="span12">
        ...
        <div id="ventana" class="portlet box blue">
            <div class="portlet-title">
                <h4><i class="icon-reorder"></i>Solicitud de horas extras</h4>
                <div class="actions">
                    <a id="btnMail" class="btn purple" href="javascript:MostrarPopUp();"><i class="icon-envelope"></i>&nbsp;Enviar Mail</a>
                    <a id="btnNuevo" class="btn green" href="?f=NSMSOHO"><i class="icon-plus"></i>&nbsp;Nuevo</a>
                    <a class="btn red" href="?f=NSLSOHO"><i class="icon-list"></i>&nbsp;Listar</a>
                </div>
